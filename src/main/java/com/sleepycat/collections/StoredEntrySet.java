...
/**
 * The Set returned by Map.entrySet(). This class may not be instantiated directly. Contrary to what
 * is stated by {@link Map#entrySet} this class does support the {@link #add} and {@link #addAll}
 * methods.
 *
 ...
 * @author Mark Hayes
 */
public class StoredEntrySet<K, V> extends StoredCollection<Map.Entry<K, V>>
  ...
  /**
   * Adds the specified element to this set if it is not already present (optional operation). This
   * method conforms to the {@link Set#add} interface.
   *
   * @param mapEntry must be a {@link Map.Entry} instance.
   * @return true if the key-value pair was added to the set (and was not previously present).
   *     <!-- begin JE only -->
   ...
   * @throws ClassCastException if the mapEntry is not a {@link Map.Entry} instance.
   ...
   *
   * @param mapEntry is a {@link Map.Entry} instance to be removed.
   * @return true if the key-value pair was removed from the set, or false if the mapEntry is not a
   *     {@link Map.Entry} instance or is not present in the set.
   *     <!-- begin JE only -->
   * @throws OperationFailureException if one of the <a
   *     href="../je/OperationFailureException.html#writeFailures">Write Operation Failures</a>
   *     occurs.
   ...
   *
   * @param mapEntry is a {@link Map.Entry} instance to be checked.
  ...
  Map.Entry<K, V> makeIteratorData(
      BaseIterator iterator,
      DatabaseEntry keyEntry,
      DatabaseEntry priKeyEntry,
      DatabaseEntry valueEntry) {

    return new StoredMapEntry(
        view.makeKey(keyEntry, priKeyEntry),

...
public class UtfOps {
  ...
  /**
   * Returns the byte length of the UTF string that would be created by converting the given
   * characters to UTF.
   *
   ...
   * @throws IndexOutOfBoundsException if a UTF character sequence at the end of the data is not
   *     complete.
   * @throws IllegalArgumentException if an illegal UTF sequence is encountered.
   */
   ...
   * @param byteOffset the offset into the byte array at which to start the conversion
   ...
   * @param isByteLen if true then len is a measure of bytes, otherwise len is a measure of
   *     characters
   ...
   * @throws IllegalArgumentException if an illegal UTF sequence is encountered.
   */
  public static int bytesToChars(
      byte[] bytes, int byteOffset, char[] chars, int charOffset, int len, boolean isByteLen)
      throws IllegalArgumentException, IndexOutOfBoundsException {
      ...
      switch ((char1 & 0xff) >> 4) {
        ...
        case 14:
          ...
          if (((char2 & 0xC0) != 0x80) || ((char3 & 0xC0) != 0x80))
            throw new IllegalArgumentException();
          chars[charOffset++] =
              (char) (((char1 & 0x0F) << 12) | ((char2 & 0x3F) << 6) | ((char3 & 0x3F) << 0));
          break;
        default:
          throw new IllegalArgumentException();
      }
   ...
   * @param charOffset the offset into the character array at which to start the conversion
  ...
  public static void charsToBytes(
      char[] chars, int charOffset, byte[] bytes, int byteOffset, int charLength) {

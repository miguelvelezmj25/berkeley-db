 ...
 *
 * <p>This class extends {@link InputStream} and its <code>read()</code> methods allow it to be used
 * as a standard input stream. In addition, it provides <code>readFast()</code> methods that are not
 * declared to throw <code>IOException</code>. <code>IOException</code> is never thrown by this
 * class.
 *
 * @author Mark Hayes
 */

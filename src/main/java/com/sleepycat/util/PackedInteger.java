 ...
 *
 * <p>Most applications should use the classes in the {@link com.sleepycat.bind.tuple} package
...
public class PackedInteger {
   ...
   *
   * <p>Because the length is stored in the first byte, this method may be called with only the
   * first byte of the packed integer in the given buffer. This method only accesses one byte at the
   * given offset.
   *
   * @param buf the buffer to read from.
   * @param off the offset in the buffer at which to start reading.
  ...
  /**
   * Writes a packed integer starting at the given buffer offset and returns the next offset to be
   * written.
   *
  ...
  /**
   * Writes a packed long integer starting at the given buffer offset and returns the next offset to
   * be written.
   *
   * @param buf the buffer to write to.
   * @param offset the offset in the buffer at which to start writing.
   ...
   *
   * @param value the long integer to be written.
   * @return the number of bytes that would be used to write the given long integer.
   */
  ...
  /**
   * Writes a packed sorted integer starting at the given buffer offset and returns the next offset
   * to be written.
   *
   * @param buf the buffer to write to.
   * @param offset the offset in the buffer at which to start writing.
  ...
  /**
   * Writes a packed sorted long integer starting at the given buffer offset and returns the next
  ...
  /**
   * Returns the number of bytes that would be written by {@link #writeSortedInt}.
   *
   * @param value the integer to be written.
   * @return the number of bytes that would be used to write the given integer.
   */
  ...
  /**
   * Returns the number of bytes that would be written by {@link #writeSortedLong}.
   *
   * @param value the long integer to be written.
   * @return the number of bytes that would be used to write the given long integer.
   */
  ...
  /**
   * @hidden Reads a reverse-packed integer ending at the given buffer offset and returns it.
   *     <p>To get the length of a reverse-packed integer before reading, call {@link
   *     #getReadIntLength} passing the offset to the last byte.
   * @param buf the buffer to read from.
   * @param off the offset in the buffer at which to start reading, which is the index of the last
   *     byte of the integer in the buffer.
   * @return the integer that was read.
   */
  ...
  /**
   * @hidden Writes a reverse-packed integer starting at the given buffer offset and returns the
   *     next offset to be written.
   *     <p>To get the length of a reverse-packed integer before writing, call {@link
   *     #getWriteIntLength}.
   * @param buf the buffer to write to.
   * @param off the offset in the buffer at which to start writing, which will be the index of the
   *     first byte of the integer in the buffer.
   * @param value the integer to be written.
   * @return the offset past the bytes written.
   */

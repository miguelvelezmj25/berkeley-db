 ...
 * transient LSNs and other misc sequences.
 */
public class NodeSequence {
  ...
  /**
   * Initialize the counters in these methods rather than a constructor so we can control the
   * initialization more precisely.
   */
  void initRealNodeId() {

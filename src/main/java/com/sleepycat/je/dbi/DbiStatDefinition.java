...
public class DbiStatDefinition {
  ...
  public static final String MB_GROUP_DESC = "Allocation of resources in the cache.";

  public static final String ENV_GROUP_NAME = "Environment";
  public static final String ENV_GROUP_DESC = "Miscellaneous environment wide statistics.";

  public static final String THROUGHPUT_GROUP_NAME = "Op";
  public static final String THROUGHPUT_GROUP_DESC = "Throughput statistics for JE calls.";

  /* The following stat definitions are used in MemoryBudget. */
  public static final String MB_SHARED_CACHE_TOTAL_BYTES_NAME = "sharedCacheTotalBytes";
  ...
  public static final StatDefinition MB_SHARED_CACHE_TOTAL_BYTES =
      new StatDefinition(
          MB_SHARED_CACHE_TOTAL_BYTES_NAME, MB_SHARED_CACHE_TOTAL_BYTES_DESC, StatType.CUMULATIVE);

  public static final String MB_TOTAL_BYTES_NAME = "cacheTotalBytes";
  ...
  public static final StatDefinition MB_TOTAL_BYTES =
      new StatDefinition(MB_TOTAL_BYTES_NAME, MB_TOTAL_BYTES_DESC, StatType.CUMULATIVE);

  public static final String MB_DATA_BYTES_NAME = "dataBytes";
  ...
  public static final StatDefinition MB_DATA_BYTES =
      new StatDefinition(MB_DATA_BYTES_NAME, MB_DATA_BYTES_DESC, StatType.CUMULATIVE);

  public static final String MB_DATA_ADMIN_BYTES_NAME = "dataAdminBytes";
  ...
  public static final StatDefinition MB_DATA_ADMIN_BYTES =
      new StatDefinition(MB_DATA_ADMIN_BYTES_NAME, MB_DATA_ADMIN_BYTES_DESC, StatType.CUMULATIVE);

  public static final String MB_DOS_BYTES_NAME = "DOSBytes";
  ...
  public static final StatDefinition MB_DOS_BYTES =
      new StatDefinition(MB_DOS_BYTES_NAME, MB_DOS_BYTES_DESC, StatType.CUMULATIVE);

  public static final String MB_ADMIN_BYTES_NAME = "adminBytes";
  ...
  public static final StatDefinition MB_ADMIN_BYTES =
      new StatDefinition(MB_ADMIN_BYTES_NAME, MB_ADMIN_BYTES_DESC, StatType.CUMULATIVE);

  public static final String MB_LOCK_BYTES_NAME = "lockBytes";
  ...
  public static final StatDefinition MB_LOCK_BYTES =
      new StatDefinition(MB_LOCK_BYTES_NAME, MB_LOCK_BYTES_DESC, StatType.CUMULATIVE);

  /* The following stat definitions are used in EnvironmentImpl. */
  public static final String ENV_RELATCHES_REQUIRED_NAME = "btreeRelatchesRequired";
  ...
  public static final String ENV_CREATION_TIME_NAME = "environmentCreationTime";
  ...
  public static final StatDefinition ENV_CREATION_TIME =
      new StatDefinition(ENV_CREATION_TIME_NAME, ENV_CREATION_TIME_DESC, StatType.CUMULATIVE);

  public static final String ENV_BIN_DELTA_GETS_NAME = "nBinDeltaGet";
  public static final String ENV_BIN_DELTA_GETS_DESC = "The number of gets performed in BIN deltas";
  public static final StatDefinition ENV_BIN_DELTA_GETS =
      new StatDefinition(ENV_BIN_DELTA_GETS_NAME, ENV_BIN_DELTA_GETS_DESC);

  public static final String ENV_BIN_DELTA_INSERTS_NAME = "nBinDeltaInsert";
  ...
  public static final StatDefinition ENV_BIN_DELTA_INSERTS =
      new StatDefinition(ENV_BIN_DELTA_INSERTS_NAME, ENV_BIN_DELTA_INSERTS_DESC);

  public static final String ENV_BIN_DELTA_UPDATES_NAME = "nBinDeltaUpdate";
  ...
  public static final StatDefinition ENV_BIN_DELTA_UPDATES =
      new StatDefinition(ENV_BIN_DELTA_UPDATES_NAME, ENV_BIN_DELTA_UPDATES_DESC);

  public static final String ENV_BIN_DELTA_DELETES_NAME = "nBinDeltaDelete";
  ...
  public static final StatDefinition ENV_BIN_DELTA_DELETES =
      new StatDefinition(ENV_BIN_DELTA_DELETES_NAME, ENV_BIN_DELTA_DELETES_DESC);

  /* The following stat definitions are used for throughput. */

  public static final String THROUGHPUT_PRI_SEARCH_NAME = "priSearch";
  ...
  public static final StatDefinition THROUGHPUT_PRI_SEARCH =
      new StatDefinition(THROUGHPUT_PRI_SEARCH_NAME, THROUGHPUT_PRI_SEARCH_DESC);

  public static final String THROUGHPUT_PRI_SEARCH_FAIL_NAME = "priSearchFail";
  ...
  public static final StatDefinition THROUGHPUT_PRI_SEARCH_FAIL =
      new StatDefinition(THROUGHPUT_PRI_SEARCH_FAIL_NAME, THROUGHPUT_PRI_SEARCH_FAIL_DESC);

  public static final String THROUGHPUT_SEC_SEARCH_NAME = "secSearch";
  ...
  public static final StatDefinition THROUGHPUT_SEC_SEARCH =
      new StatDefinition(THROUGHPUT_SEC_SEARCH_NAME, THROUGHPUT_SEC_SEARCH_DESC);

  public static final String THROUGHPUT_SEC_SEARCH_FAIL_NAME = "secSearchFail";
  ...
  public static final StatDefinition THROUGHPUT_SEC_SEARCH_FAIL =
      new StatDefinition(THROUGHPUT_SEC_SEARCH_FAIL_NAME, THROUGHPUT_SEC_SEARCH_FAIL_DESC);

  public static final String THROUGHPUT_PRI_POSITION_NAME = "priPosition";
  ...
  public static final StatDefinition THROUGHPUT_PRI_POSITION =
      new StatDefinition(THROUGHPUT_PRI_POSITION_NAME, THROUGHPUT_PRI_POSITION_DESC);

  public static final String THROUGHPUT_SEC_POSITION_NAME = "secPosition";
  ...
  public static final StatDefinition THROUGHPUT_SEC_POSITION =
      new StatDefinition(THROUGHPUT_SEC_POSITION_NAME, THROUGHPUT_SEC_POSITION_DESC);

  public static final String THROUGHPUT_PRI_INSERT_NAME = "priInsert";
  ...
  public static final StatDefinition THROUGHPUT_PRI_INSERT =
      new StatDefinition(THROUGHPUT_PRI_INSERT_NAME, THROUGHPUT_PRI_INSERT_DESC);

  public static final String THROUGHPUT_PRI_INSERT_FAIL_NAME = "priInsertFail";
  ...
  public static final String THROUGHPUT_SEC_INSERT_NAME = "secInsert";
  ...
  public static final StatDefinition THROUGHPUT_SEC_INSERT =
      new StatDefinition(THROUGHPUT_SEC_INSERT_NAME, THROUGHPUT_SEC_INSERT_DESC);

  public static final String THROUGHPUT_PRI_UPDATE_NAME = "priUpdate";
  ...
  public static final StatDefinition THROUGHPUT_PRI_UPDATE =
      new StatDefinition(THROUGHPUT_PRI_UPDATE_NAME, THROUGHPUT_PRI_UPDATE_DESC);

  public static final String THROUGHPUT_SEC_UPDATE_NAME = "secUpdate";
  ...
  public static final StatDefinition THROUGHPUT_SEC_UPDATE =
      new StatDefinition(THROUGHPUT_SEC_UPDATE_NAME, THROUGHPUT_SEC_UPDATE_DESC);

  public static final String THROUGHPUT_PRI_DELETE_NAME = "priDelete";
  ...
  public static final StatDefinition THROUGHPUT_PRI_DELETE =
      new StatDefinition(THROUGHPUT_PRI_DELETE_NAME, THROUGHPUT_PRI_DELETE_DESC);

  public static final String THROUGHPUT_PRI_DELETE_FAIL_NAME = "priDeleteFail";
  ...
  public static final StatDefinition THROUGHPUT_PRI_DELETE_FAIL =
      new StatDefinition(THROUGHPUT_PRI_DELETE_FAIL_NAME, THROUGHPUT_PRI_DELETE_FAIL_DESC);

  public static final String THROUGHPUT_SEC_DELETE_NAME = "secDelete";
  ...
  public static final StatDefinition THROUGHPUT_SEC_DELETE =
      new StatDefinition(THROUGHPUT_SEC_DELETE_NAME, THROUGHPUT_SEC_DELETE_DESC);
}

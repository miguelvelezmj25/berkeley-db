...
/**
 * An enumeration of different api call sources for replication, currently for debugging. This is
 * also intended to support the future possibility of providing application level visibility into
 * the replication operation stream.
 */
public class Operation {

  public static final Operation PUT = new Operation((byte) 1, "PUT");

...
public class SequenceStatDefinition {
  ...
  public static final StatDefinition SEQUENCE_GETS =
      new StatDefinition(
          "nGets", "Number of times that Sequence.get was called " + "successfully.");
  ...
  public static final StatDefinition SEQUENCE_STORED_VALUE =
      new StatDefinition("current", "The current value of the sequence in the " + "database.");

  public static final StatDefinition SEQUENCE_CACHE_VALUE =
      new StatDefinition("value", "The current cached value of the sequence.");

  public static final StatDefinition SEQUENCE_CACHE_LAST =
      new StatDefinition("lastValue", "The last cached value of the sequence.");

  public static final StatDefinition SEQUENCE_RANGE_MIN =
      new StatDefinition("min", "The minimum permitted value of the sequence.");

  public static final StatDefinition SEQUENCE_RANGE_MAX =
      new StatDefinition("max", "The maximum permitted value of the sequence.");

  public static final StatDefinition SEQUENCE_CACHE_SIZE =
      new StatDefinition(
          "cacheSize", "The mumber of values that will be cached in " + "this handle.");
}

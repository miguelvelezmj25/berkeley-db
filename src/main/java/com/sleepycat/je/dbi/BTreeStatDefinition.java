...
public class BTreeStatDefinition {
  ...
  public static final String GROUP_DESC = "Composition of btree, types and counts of nodes.";
  ...
  public static final StatDefinition BTREE_IN_COUNT =
      new StatDefinition(
          "inCount",
          "Number of internal nodes in database's btree. " + "BINs are not included.",
          StatType.CUMULATIVE);

  public static final StatDefinition BTREE_LN_COUNT =
      new StatDefinition(
          "lnCount", "Number of leaf nodes in the database's btree.", StatType.CUMULATIVE);

  public static final StatDefinition BTREE_MAINTREE_MAXDEPTH =
      new StatDefinition(
          "mainTreeMaxDepth", "Maximum depth of the in-memory tree.", StatType.CUMULATIVE);

  public static final StatDefinition BTREE_INS_BYLEVEL =
      new StatDefinition(
          "insByLevel", "Histogram of internal nodes by level.", StatType.CUMULATIVE);

  public static final StatDefinition BTREE_BINS_BYLEVEL =
      new StatDefinition(
          "binsByLevel", "Histogram of bottom internal nodes by level.", StatType.CUMULATIVE);

  public static final StatDefinition BTREE_RELATCHES_REQUIRED =
      new StatDefinition("relatchesRequired", "Number of latch upgrades (relatches) required.");

  public static final StatDefinition BTREE_ROOT_SPLITS =
      new StatDefinition("nRootSplits", "Number of times the root was split.");

  public static final StatDefinition BTREE_BIN_ENTRIES_HISTOGRAM =
      new StatDefinition(
          "binEntriesHistogram",
          "Histogram of bottom internal nodes fill " + "percentage.",
          StatType.CUMULATIVE);
}

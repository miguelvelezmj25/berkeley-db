...
public abstract class JEMBean implements MBeanRegistrar {
   ...
   *
   * @return array of MBeanAttributeInfo objects describing the available attributes.
   */
   ...
   *
   * <p>Since the process of getting constructors is the same for each concrete MBean, define it
   * here to reduce coding work.
   *
   * @return array of MBeanConstructorInfo objects describing the constructor attributes.
   */
   ...
   *
   * <p>Register this MBean with the MBeanServer.
   */
   ...
   * For EnvironmentImpl.MBeanRegistrar interface.
   *
   * <p>Remove this MBean from the MBeanServer.
   */
   ...
   *     <p>Implement the getMBeanInfo method of DynamicMBean.
   */

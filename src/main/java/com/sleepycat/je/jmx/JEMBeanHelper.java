...
/**
 * @deprecated As of JE 4, JEMBeanHelper is deprecated in favor of the concrete MBeans available by
 *     default with a JE environment. These MBeans can be registered and enabled by the environment
 *     by setting the following JVM property: JEMonitor: This MBean provides general stats
 *     monitoring and access to basic environment level operations.
 *     <p>JEMBeanHelper is a utility class for the MBean implementation which wants to add
 *     management of a JE environment to its capabilities. MBean implementations can contain a
 *     JEMBeanHelper instance to get MBean metadata for JE and to set attributes, get attributes,
 *     and invoke operations.
 *     <p>com.sleepycat.je.jmx.JEMonitor and the example program jmx.JEApplicationMBean are two
 *     MBean implementations which provide support different application use cases. See those
...
public class JEMBeanHelper {
  ...
  private static final MBeanAttributeInfo[] TRANSACTIONAL_ATTR = {
    ...
    new MBeanAttributeInfo(
        ATT_TXN_TIMEOUT,
        "java.lang.Long",
        "Transaction timeout, in seconds. A value " + "of 0 means there is no timeout.",
        true, // readable
        false, // writable
        false) // isIs
  };
  ...
  private static final MBeanAttributeInfo[] CREATE_ATTR = {
    new MBeanAttributeInfo(
        ATT_SET_READ_ONLY,
        "java.lang.Boolean",
        "True if this environment should be opened " + "in readonly mode.",
        true, // readable
        true, // writable
        false), // isIs
    new MBeanAttributeInfo(
        ...
        "java.lang.Boolean",
        "True if this environment should be opened " + "in transactional mode.",
        true, // readable
        true, // writable
        false), // isIs
    new MBeanAttributeInfo(
  ...
  private static final MBeanParameterInfo[] statParams = {
    new MBeanParameterInfo(
        "clear", "java.lang.Boolean", "If true, reset statistics after reading."),
    new MBeanParameterInfo(
        "fast",
        "java.lang.Boolean",
   ...
   * @param canConfigure If true, the helper will show environment configuration attributes.
   */
  ...
  /**
   * If the helper was instantiated with canConfigure==true, it shows environment configuration
   * attributes. Those attributes are returned within this EnvironmentConfig object for use in
   * opening environments.
   *
   * @return EnvironmentConfig object which saves configuration attributes recorded through MBean
   *     attributes.
   */
   ...
   * @return list of MBeanAttributeInfo objects describing the available attributes.
   */

...
/**
 * JEDiagnostics is a debugging mbean for a non replicated JE Environment. This is intended as a
 * locus of field support functionality. While it may be used by the application developer, the
 * primary use case is for a support situation. Currently much of this functionality is also
 * available through the standard java.util.logging MBean.
 *
 * <p>It is a concrete MBean created by registering a JE Environment as an MBean through setting the
 * JEDiagnostics system property. It only works on an active JE Environment, and one Environment can
 * only have one JEDiagnostics instance. There are two attributes and one operation:
 *
 * <p><u>Attributes:</u>
 *
 * <ul>
 ...
 *
 * <ul>
 *   <li>resetLoggingLevel: which sets the level for the current loggers in the LogManager.
 * </ul>
 *
 * <p>We can use these attributes and operations to dynamically change the logging level for
 * debugging purposes.
 */
public class JEDiagnostics extends JEMBean implements DynamicMBean {
  ...
  protected static final MBeanAttributeInfo ATT_CONSOLEHANDLER_LEVEL =
      new MBeanAttributeInfo(
          CONSOLEHANDLER_LEVEL, "java.lang.String", "ConsoleHandler level.", true, true, false);

  /* FileHandler. */
  protected static final MBeanAttributeInfo ATT_FILEHANDLER_LEVEL =
      new MBeanAttributeInfo(
          FILEHANDLER_LEVEL, "java.lang.String", "FileHandler level.", true, true, false);
  ...
  protected static final MBeanParameterInfo[] resetLoggingParams = {
    new MBeanParameterInfo("Logger Name", "java.lang.String", "Specify the target logger."),
    new MBeanParameterInfo(
        "Logging Level", "java.lang.String", "The new logging level for the target logger.")
  };
  ...
  public void setAttribute(Attribute attribute)
    ...
    try {
      ...
      throw new InvalidAttributeValueException(
          "Setting value for attribute " + name + "is invalid because of " + e.getMessage());

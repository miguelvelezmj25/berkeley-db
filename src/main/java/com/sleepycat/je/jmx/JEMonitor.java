 ...
 * The MBean is registered and enabled when the system property JEMonitor is set. It only works on
 * an active JE Environment, and an Environment can only register one instance of JEMonitor.
 *
 * @see <a href="{@docRoot}/../jconsole/JConsole-plugin.html">Monitoring JE with JConsole and
 *     JMX</a>
 */
public class JEMonitor extends JEMBean implements DynamicMBean {
  ...
  private static final MBeanAttributeInfo[] COMMON_ATTR = {
    new MBeanAttributeInfo(
        ATT_ENV_HOME, "java.lang.String", "Environment home directory.", true, false, false)
  };
  ...
  private static final MBeanAttributeInfo[] OPEN_ATTR = {
    ...
    new MBeanAttributeInfo(
        ...
        true),
    new MBeanAttributeInfo(
        ATT_CACHE_SIZE, "java.lang.Long", "Cache size, in bytes.", true, true, false),
    new MBeanAttributeInfo(
        ATT_CACHE_PERCENT,
        "java.lang.Integer",
        ...
        false),
    new MBeanAttributeInfo(
        ATT_LOCK_TIMEOUT, "java.lang.Long", "Lock timeout, in microseconds.", true, false, false)
  };
  ...
  public Object invoke(String actionName, Object[] params, String[] signature)
    ...
    try {
      if (actionName.equals(OP_CLEAN)) {
        ...
        return env.getTransactionStats(getStatsConfig(params)).toString();
        ...
        return env.getStats(getStatsConfig(new Object[] {false, true})).getTips();

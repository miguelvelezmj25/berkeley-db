 ...
 * EnvironmentConfig#LOCK_OLD_LOCK_EXCEPTIONS} is set to true. Non-blocking transactions are
 ...
 *
 * <p>For compatibility with JE 3.3 and earlier, {@link LockNotGrantedException} is thrown instead
 * of {@link LockNotAvailableException} when {@link EnvironmentConfig#LOCK_OLD_LOCK_EXCEPTIONS} is
 * set to true. This configuration parameter is false by default. See {@link
 * EnvironmentConfig#LOCK_OLD_LOCK_EXCEPTIONS} for information on the changes that should be made to
 * all applications that upgrade from JE 3.3 or earlier.
 *

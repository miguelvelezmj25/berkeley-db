...
public class SequenceConfig implements Cloneable {
  ...
  /**
   * Configures the {@link Database#openSequence Database.openSequence} method to create the
   ...
   *
   * @param allowCreate If true, configure the {@link Database#openSequence Database.openSequence}
  ...
  /**
   * Returns true if the {@link Database#openSequence Database.openSequence} method is configured to
   * create the sequence if it does not already exist.
   *
   * <p>This method may be called at any time during the life of the application.
   *
   * @return true if the {@link Database#openSequence Database.openSequence} method is configured to
   *     create the sequence if it does not already exist.
   */
   ...
   * <p>This method may be called at any time during the life of the application.
   *
   * @param cacheSize The number of elements cached by a sequence handle. May not be larger than the
   *     size of the range defined by {@link #setRange}.
   * @return this
   */
   ...
   * <p>This method may be called at any time during the life of the application.
   *
   * @param decrement If true, specify that the sequence should be decremented.
   * @return this
   */
  ...
  /**
   * Configures the {@link Database#openSequence Database.openSequence} method to fail if the
   ...
   * <p>This method may be called at any time during the life of the application.
   *
   * @param exclusiveCreate If true, configure the {@link Database#openSequence
   ...
   *
   * <p>The default initial value is zero.
   *
   * <p>This call is only effective when the sequence is being created.
   *
   * <p>This method may be called at any time during the life of the application.
   *
   * @param initialValue The initial value for a sequence. Must be within the range minimum and
   ...
   * <p>This method may be called at any time during the life of the application.
   *
   * @param autoCommitNoSync If true, configure auto-commit operations on the sequence to not flush
   *     the transaction log.
   * @return this
   */
  ...
  /**
   * Returns true if the auto-commit operations on the sequence are configure to not flush the
   * transaction log..
   *
   * <p>This method may be called at any time during the life of the application.
   *
   * @return true if the auto-commit operations on the sequence are configure to not flush the
   *     transaction log..
   */
   ...
   *
   * <p>The default minimum is {@code Long.MIN_VALUE} and the default maximum is {@code
   * Long.MAX_VALUE}.
   *
   * @param min The minimum value for the sequence. Must be less than max.
   * @param max The maximum value for the sequence. Must be greater than min.
   * @return this
   */
  ...
  /**
   * @hidden Configures a sequence range minimum value. This call is only effective when the
   *     sequence is being created.
   *     <p>The default minimum is {@code Long.MIN_VALUE}
   * @param min The minimum value for the sequence. Must be less than max.
   * @return this
   */
  ...
  /**
   * @hidden Configures a sequence range maximum value. This call is only effective when the
   *     sequence is being created.
   *     <p>the default maximum is {@code Long.MAX_VALUE}.
   * @param max The maximum value for the sequence. Must be greater than min.
   * @return this
   */
  ...
  /**
   * Specifies that the sequence should wrap around when it is incremented (decremented) past the
   * specified maximum (minimum) value.
   *
   * <p>The default value is false.
   *
   * <p>This method may be called at any time during the life of the application.
   *
   * @param wrap If true, specify that the sequence should wrap around when it is incremented
  ...
  /**
   * Returns true if the sequence will wrap around when it is incremented (decremented) past the
   * specified maximum (minimum) value.
   *
   * <p>This method may be called at any time during the life of the application.
   *
   * @return true if the sequence will wrap around when it is incremented (decremented) past the
   *     specified maximum (minimum) value.
   */

...
/** Describes the result of the {@link Database#preload Database.preload} operation. */
public class PreloadStatus implements Serializable {
  ...
  /** {@link Database#preload Database.preload} was successful. */
  public static final PreloadStatus SUCCESS = new PreloadStatus("SUCCESS");

  /** {@link Database#preload Database.preload} filled maxBytes of the cache. */
  public static final PreloadStatus FILLED_CACHE = new PreloadStatus("FILLED_CACHE");

  /** {@link Database#preload Database.preload} took more than maxMillisecs. */
  ...
  public static final PreloadStatus USER_HALT_REQUEST = new PreloadStatus("USER_HALT_REQUEST");
}

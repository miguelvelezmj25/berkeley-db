...
/**
 * A PreparedTxn is used at recovery for processing a TXN_PREPARE log entry. It is provides
 * essentially the same functionality as a TXN but lets the calling code set the transaction id.
 */
public class PreparedTxn extends Txn {

  private PreparedTxn(EnvironmentImpl envImpl, TransactionConfig config, long mandatedId)
      throws DatabaseException {

    super(envImpl, config, ReplicationContext.NO_REPLICATE, mandatedId);
  }

  public static PreparedTxn createPreparedTxn(

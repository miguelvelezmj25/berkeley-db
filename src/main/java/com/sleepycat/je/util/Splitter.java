...
/**
 * Splitter is used to split a string based on a delimiter. Support includes double quoted strings,
 * and the escape character. Raw tokens are returned that include the double quotes, white space,

...
/**
 * DeltaInfo holds the delta for one BIN entry in a partial BIN log entry. The data here is all that
 * we need to update a BIN to its proper state.
 */

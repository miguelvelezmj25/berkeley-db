...
/**
 * A Bloom filter implementation, highly specialized for use in BIN deltas. Both space and
 * computation times are minimized, with a potential small loss in accuracy.
 *
 * <p>A nice introduction to bloom filters can be found here:

...
/**
 * INDeleteInfo encapsulates the information logged about the removal of a child from an IN during
 * IN compression.
 *
 * <p>As of JE 3.3.87, INDelete is no longer logged becaue the root compression feature has been
 * removed. However, INDelete must still be processed in log files created with 3.3.87 and earlier.
 * [#17546]
 *

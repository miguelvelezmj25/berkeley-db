...
public class INDupDeleteInfo implements Loggable {
  ...
  /**
   * Returns true if we are certain that this log entry reflects deletion of a DIN root. Returns
   * false if it may or may not be a DIN root. [#18663]
   */

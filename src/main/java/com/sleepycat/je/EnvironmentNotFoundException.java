...
/**
 * Thrown by the {@link Environment} constructor when {@code EnvironmentConfig AllowCreate} property
 * is false (environment creation is not permitted), but there are no log files in the environment
 * directory.
 *
 * @since 4.0
 */

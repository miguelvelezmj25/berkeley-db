...
public class ReservedFileInfo {
  ...
  ReservedFileInfo(final VLSN firstVLSN, final VLSN lastVLSN, final Set<DatabaseId> dbIds) {
  ...
  public static void objectToEntry(final ReservedFileInfo info, final DatabaseEntry entry) {

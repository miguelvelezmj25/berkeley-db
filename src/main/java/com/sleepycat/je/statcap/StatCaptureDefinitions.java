...
public class StatCaptureDefinitions {
  ...
  private static final StatDefinition[] cleanerStats = {
  ...
  private static final StatDefinition[] dbiStats = {
  ...
  private static final StatDefinition[] environmentStats = {
  ...
  private static final StatDefinition[] evictorStats = {
  ...
  private static final StatDefinition[] offHeapStats = {
  ...
  private static final StatDefinition[] inCompStats = {
  ...
  private static final StatDefinition[] latchStats = {
  ...
  private static final StatDefinition[] logStats = {
  ...
  private static final StatDefinition[] checkpointStats = {
  ...
  private static final StatDefinition[] throughputStats = {
  ...
  private static final StatDefinition[] lockStats = {
    LockStatDefinition.LOCK_REQUESTS, LockStatDefinition.LOCK_WAITS,
  };
  ...
  public static StatManager.SDef[] maxStats = {
    new StatManager.SDef(LogStatDefinition.GROUP_NAME, LogStatDefinition.GRPCMGR_FSYNC_MAX_TIME)
  };
  ...
  /**
   * Used to get a statistics definition. This method is used for testing purposes only.
   *

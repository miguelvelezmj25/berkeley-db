...
/**
 * Base class for exceptions thrown when a read or write operation fails because of a secondary
 * constraint or integrity problem. Provides accessors for getting further information about the
 * database and keys involved in the failure. See subclasses for more information.
 *
...
public abstract class SecondaryReferenceException extends OperationFailureException {
   ...
   * @hidden
   */
  public SecondaryReferenceException(
      Locker locker,
      String message,
      String secDbName,
  ...
  /**
   * Returns the secondary key being accessed during the failure. Note that in some cases, the
   * returned primary key can be null.
   */
  ...
  /**
   * Returns the primary key being accessed during the failure. Note that in some cases, the
   * returned primary key can be null.
   */

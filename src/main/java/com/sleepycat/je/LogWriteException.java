...
/**
 * Thrown when an {@code IOException} or other failure occurs when writing to the JE log. This
 * exception may be indicative of a full disk, although an {@code IOException} does not contain
 * enough information to determine this definitively.
 *
 * <p>This exception may be thrown as the result of any write operation, including record writes,
 * checkpoints, etc.
 *
...
public class LogWriteException extends EnvironmentFailureException {
   ...
   * @hidden
   */
  private LogWriteException(String message, LogWriteException cause) {
    super(message, cause);
  }

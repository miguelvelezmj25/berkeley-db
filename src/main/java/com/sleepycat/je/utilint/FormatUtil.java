...
public class FormatUtil {
   ...
   * The representation is made compact by identifying ranges so that the sorted set can be
   * represented as a sequence of hex ranges and singletons.
   */
  ...
  private static void flushRange(final StringBuilder sb, long rstart, long rend) {
    ...
    if (rstart == rend) {
      ...
      sb.append(" 0x")
          .append(Long.toHexString(rstart))
          .append("-")
          .append("0x")
          .append(Long.toHexString(rend));
    }
  }
}

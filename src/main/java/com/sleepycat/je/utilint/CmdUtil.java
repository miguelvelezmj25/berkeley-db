...
public class CmdUtil {
  ...
  /**
   * Parse a string into a long. If the string starts with 0x, this is a hex number, else it's
   * decimal.
   */
  ...
  /**
   * Create an environment suitable for utilities. Utilities should in general send trace output to
   * the console and not to the db log.
   */
  ...
  /**
   * Returns a description of the java command for running a utility, without arguments. For
   * utilities the last name of the class name can be specified when "-jar je.jar" is used.
   */

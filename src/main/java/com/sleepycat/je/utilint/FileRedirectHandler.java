...
/**
 * Redirects logging messages to the the owning environment's file handler, so that messages can be
 * prefixed with an environment name and sent to the correct logging file.
 *
 * <p>This class must not extend FileHandler itself, since FileHandlers open their target log files
 * at construction time, and this FileHandler is meant to be stateless.
 */

...
public class DatabaseUtil {
   ...
   *
   * @throws IllegalArgumentException via any API method that takes a required DatabaseEntry param
   */
  public static void checkForNullDbt(
      final DatabaseEntry entry, final String name, final boolean checkData) {
    if (entry == null) {

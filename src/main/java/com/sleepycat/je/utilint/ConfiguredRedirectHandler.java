...
/**
 * Redirects logging messages to the owning environment's application configured handler, if one was
 * specified through EnvironmentConfig.setLoggingHandler(). Handlers for JE logging can be
 * configured through EnvironmentConfig, to support handlers which: - require a constructor with
 * arguments - is specific to this environment, and multiple environments exist in the same process.
 */

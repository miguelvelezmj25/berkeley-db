...
/**
 * Redirects logging messages to the owning environment's console handler, so that messages can be
 * prefixed with an environment name. See LoggerUtils.java for an explanation of why loggers must be
 * instantiated per-class rather than per-class-instance.
 *
 * <p>In rare cases, this ConsoleHandler may be used to actually publish on its own.
 */

...
/**
 * A long JE stat component generated from an exponential moving average over a specified time
 * period of the rate of change in a long value over time.
 */
public class LongAvgRate extends MapStatComponent<Long, LongAvgRate> {
  ...
  /**
   * Adds a new value to the average, ignoring values that are less than {@link #MIN_PERIOD}
   * milliseconds older than the last entry.
   *
  ...
  /**
   * Do an add, letting the caller arrange to synchronize on this instance and the argument safely.
   */
  ...
  /**
   * Create and return a new stat that includes the most recent values from this stat and another
   * stat.
   *
   * @param other the other stat
  ...
  /**
   * Returns the time the last new value was added, or 0 if no values have been added.
   *

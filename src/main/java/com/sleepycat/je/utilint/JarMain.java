...
/**
 * Used as the main class for the manifest of the je.jar file, and so it is executed when running:
 * java -jar je.jar. The first argument must be the final part of the class name of a utility in the
 * com.sleepycat.je.util package, e.g., DbDump. All following parameters are passed to the main
 * method of the utility and are processed as usual.
 *
 * <p>Apart from the package, this class is ambivalent about the name of the utility specified; the
 * only requirement is that it must be a public static class and must contain a public static main
 * method.
 */
public class JarMain {
  ...
  private static final HashMap<String, String> utilPrefixMap = new HashMap<String, String>();

...
/**
 * Internal class used for transient event tracing. Subclass this with specific events. Subclasses
 * should have toString methods for display and events should be added by calling
 * EventTrace.addEvent();
 */

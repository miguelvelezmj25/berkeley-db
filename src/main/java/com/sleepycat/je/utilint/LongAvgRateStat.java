...
/**
 * A long JE stat generated from an exponential moving average over a specified time period of the
 * rate of change in a value over time.
 */
public class LongAvgRateStat extends Stat<Long> {
  ...
  /**
   * Create a stat that includes the newest entries from this stat and the base stat. This method
   * does not use negative intervals, since negation does not work properly for this non-additive
   * stat. The base argument must be a LongAvgRateStat.
   */
  @Override

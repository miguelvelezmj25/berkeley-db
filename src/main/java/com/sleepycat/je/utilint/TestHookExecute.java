...
/**
 * Execute a test hook if set. This wrapper is used so that test hook execution can be packaged into
 * a single statement that can be done within an assert statement.
 */

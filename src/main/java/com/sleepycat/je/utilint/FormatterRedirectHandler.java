...
/**
 * Redirect the ConsoleHandler to use a specific Formatter. This is the same redirect approach used
 * in com.sleepycat.je.utilint.ConsoleRedirectHandler, but in this case, an environment (and its
 * associated stored console handler) is not available. In order to still have prefixed logging
 * output, we incur the higher level cost of resetting the formatter.
 */
public class FormatterRedirectHandler extends java.util.logging.ConsoleHandler {

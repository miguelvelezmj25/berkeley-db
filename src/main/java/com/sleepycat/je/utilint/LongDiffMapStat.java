...
/**
 * A JE stat that maintains a map of individual {@link LongDiffStat} values which can be looked up
 * with a String key, and that returns results as a formatted string. Only supports CUMULATIVE
 * stats.
 */
public final class LongDiffMapStat extends MapStat<Long, LongDiffStat> {
  ...
  /**
   * Creates an instance of this class. The definition type must be CUMULATIVE.
   *

...
/**
 * A base class for JE stats that map String keys to component statistics, and that return results
...
public abstract class MapStat<T, C extends MapStatComponent<T, C>> extends Stat<String> {
  ...
  /**
   * Maps keys to individual statistics. Synchronize on the MapStat instance when accessing this
   * field.
   */
  ...
  /**
   * Creates an instance of this class as a copy of another instance. This instance should be a new
   * instance to avoid lock ordering concerns.
   *
  ...
  /**
   * Returns a map from keys to values of individual statistics, ignoring individual statistics that
   * are not set.
   *
  ...
  /**
   * Returns the map as a string in the format returned by {@link #getFormattedValue}, but with
   * values presented without using commas.
   */
  @Override
  public String get() {
  ...
  /**
   * This implementation returns the keys and values of the individual statistics in the format:

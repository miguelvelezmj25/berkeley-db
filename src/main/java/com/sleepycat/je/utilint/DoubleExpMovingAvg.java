...
/**
 * A double JE stat component generated from an exponential moving average over a specified time
 * period of values supplied with associated times, to support averaging values that are generated
...
public class DoubleExpMovingAvg extends MapStatComponent<Double, DoubleExpMovingAvg> {
  ...
  /**
   * The time in milliseconds specified with the previous value, or 0 if no values have been
   * provided. Synchronize on this instance when accessing this field.
   */
  private long prevTime;

  /**
   * The current average, or 0 if no values have been provided. Synchronize on this instance when
   * accessing this field.
   */
  private double avg;

  /**
   * Creates an instance of this class. The {@code periodMillis} represents the time period in
   * milliseconds over which values will be averaged.
   *
  ...
  /**
   * Adds a new value to the average, ignoring values that are not newer than time of the previous
   * call.
   *
  ...
  public synchronized String toString() {
    return "DoubleExpMovingAvg[name="
        + name
        + ", avg="
        + avg
        + ", prevTime="

 ...
 *
 * <p>There is one JEVersion object per running JVM and it may be accessed using the static field
...
public class JEVersion implements Comparable<JEVersion>, Serializable {
  ...
  /** Release version. */
  public static final JEVersion CURRENT_VERSION = new JEVersion(7, 5, 11, null);

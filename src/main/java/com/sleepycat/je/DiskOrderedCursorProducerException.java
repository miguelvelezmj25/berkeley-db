...
/**
 * Thrown by {@link ForwardCursor#getNext ForwardCursor.getNext} when a {@link DiskOrderedCursor}
 * producer thread throws an exception. This exception wraps that thrown exception;
 *
 * @since 5.0
 */

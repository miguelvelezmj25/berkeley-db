...
/**
 * Thrown when a conflict is detected between a minimum JE version requirement and the JE version of
 * a particular node.
 */
public class MinJEVersionUnsupportedException extends Exception {
   ...
   */
  public MinJEVersionUnsupportedException(
      final JEVersion minVersion, final String nodeName, final JEVersion nodeVersion) {
    if (minVersion == null) {

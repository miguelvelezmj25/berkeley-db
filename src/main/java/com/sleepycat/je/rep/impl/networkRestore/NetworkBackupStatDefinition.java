...
public class NetworkBackupStatDefinition {
  ...
  public static StatDefinition BACKUP_FILE_COUNT =
      new StatDefinition("backupFileCount", "The total number of files.");
  ...
  public static StatDefinition FETCH_COUNT =
      new StatDefinition(
          "fetchCount", "The number of files that were actually transferred from the " + "server");
  ...
  public static StatDefinition EXPECTED_BYTES =
      new StatDefinition(
          "expectedBytes", "The number of bytes that are expected to be transferred.", CUMULATIVE);

  public static StatDefinition TRANSFERRED_BYTES =
      new StatDefinition(
          "transferredBytes", "The number of bytes that have been transferred so far.", CUMULATIVE);

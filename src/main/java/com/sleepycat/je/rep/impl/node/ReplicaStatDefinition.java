...
public class ReplicaStatDefinition {
  ...
  public static final StatDefinition N_LAG_CONSISTENCY_WAITS =
      new StatDefinition(N_LAG_CONSISTENCY_WAITS_NAME, N_LAG_CONSISTENCY_WAITS_DESC);

  public static final String N_LAG_CONSISTENCY_WAIT_MS_NAME = "nLagConsistencyWaitMS";
  ...
  public static final StatDefinition N_LAG_CONSISTENCY_WAIT_MS =
      new StatDefinition(N_LAG_CONSISTENCY_WAIT_MS_NAME, N_LAG_CONSISTENCY_WAIT_MS_DESC);

  public static final String N_VLSN_CONSISTENCY_WAITS_NAME = "nVLSNConsistencyWaits";
  ...
  public static final StatDefinition N_VLSN_CONSISTENCY_WAITS =
      new StatDefinition(N_VLSN_CONSISTENCY_WAITS_NAME, N_VLSN_CONSISTENCY_WAITS_DESC);

  public static final String N_VLSN_CONSISTENCY_WAIT_MS_NAME = "nVLSNConsistencyWaitMS";
  ...
  public static final StatDefinition N_VLSN_CONSISTENCY_WAIT_MS =
      new StatDefinition(N_VLSN_CONSISTENCY_WAIT_MS_NAME, N_VLSN_CONSISTENCY_WAIT_MS_DESC);
}

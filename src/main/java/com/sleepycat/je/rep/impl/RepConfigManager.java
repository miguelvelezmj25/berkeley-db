...
public class RepConfigManager extends DbConfigManager {
  ...
  /**
   * If the replication configuration object was set with overridden validation, we need to continue
   * to override when we generate a new configuration.
   */
  ...
  /**
   * Verifies that the environment config is suitable for a replicated environment.
   *
  ...
  /**
   * Create a new ReplicationConfig for use in creating Replicator handles. Be sure to only pick out

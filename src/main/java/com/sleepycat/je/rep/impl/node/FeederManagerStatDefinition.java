...
public class FeederManagerStatDefinition {
  ...
  public static final String N_FEEDERS_CREATED_NAME = "nFeedersCreated";
  ...
  public static final StatDefinition N_FEEDERS_CREATED =
      new StatDefinition(N_FEEDERS_CREATED_NAME, N_FEEDERS_CREATED_DESC);

  public static final String N_FEEDERS_SHUTDOWN_NAME = "nFeedersShutdown";
  ...
  public static final StatDefinition N_FEEDERS_SHUTDOWN =
      new StatDefinition(N_FEEDERS_SHUTDOWN_NAME, N_FEEDERS_SHUTDOWN_DESC);

  /* Naming conflict -- use SNAME suffix in this one case. */
  public static final String N_MAX_REPLICA_LAG_SNAME = "nMaxReplicaLag";
  ...
  public static final StatDefinition N_MAX_REPLICA_LAG =
      new StatDefinition(N_MAX_REPLICA_LAG_SNAME, N_MAX_REPLICA_LAG_DESC);

  public static final String N_MAX_REPLICA_LAG_NAME_NAME = "nMaxReplicaLagName";
  ...
  public static final StatDefinition N_MAX_REPLICA_LAG_NAME =
      new StatDefinition(N_MAX_REPLICA_LAG_NAME_NAME, N_MAX_REPLICA_LAG_NAME_DESC);

  public static final String REPLICA_DELAY_MAP_NAME = "replicaDelayMap";
  ...
  public static final StatDefinition REPLICA_DELAY_MAP =
      new StatDefinition(REPLICA_DELAY_MAP_NAME, REPLICA_DELAY_MAP_DESC, CUMULATIVE);
  ...
  public static final String REPLICA_LAST_COMMIT_VLSN_MAP_NAME = "replicaLastCommitVLSNMap";
  ...
  public static final StatDefinition REPLICA_LAST_COMMIT_VLSN_MAP =
      new StatDefinition(
          REPLICA_LAST_COMMIT_VLSN_MAP_NAME, REPLICA_LAST_COMMIT_VLSN_MAP_DESC, CUMULATIVE);

  public static final String REPLICA_VLSN_LAG_MAP_NAME = "replicaVLSNLagMap";
  ...
  public static final StatDefinition REPLICA_VLSN_LAG_MAP =
      new StatDefinition(REPLICA_VLSN_LAG_MAP_NAME, REPLICA_VLSN_LAG_MAP_DESC, CUMULATIVE);

  public static final String REPLICA_VLSN_RATE_MAP_NAME = "replicaVLSNRateMap";
  ...
  public static final StatDefinition REPLICA_VLSN_RATE_MAP =
      new StatDefinition(REPLICA_VLSN_RATE_MAP_NAME, REPLICA_VLSN_RATE_MAP_DESC);
}

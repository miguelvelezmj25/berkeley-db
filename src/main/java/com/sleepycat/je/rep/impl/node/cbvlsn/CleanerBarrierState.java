...
/**
 * This class is not used if the GlobalCBVLSN is defunct -- see {@link GlobalCBVLSN}. Instances of
 * this class are created in order to initialize the RepNodeImpl.barrierState field or pass
 * parameters, but these instances are not actually used when the GlobalCBVLSN is defunct.
 *
 * <p>Encapsulates the last known syncup state associated with a node.
 */
public class CleanerBarrierState implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (lastLocalCBVLSN == null) {
      ...
      return barrierTime == other.barrierTime;
  }

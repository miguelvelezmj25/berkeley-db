...
/**
 * The InstanceParams class captures configuration information for object instantiation by
...
public class InstanceParams {
   ...
   *
   * @param context the configuration context from which an instantiation is being generated.

...
public interface PasswordSource {
   ...
   *
   * @return a copy of the password. It is recommended that the caller overwrite the return value
   *     with other characters when the password is no longer required.
   */
  char[] getPassword();
}

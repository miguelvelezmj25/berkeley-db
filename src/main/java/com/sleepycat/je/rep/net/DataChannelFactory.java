...
public interface DataChannelFactory {
   ...
   * @return an implementation of DataChannel that wraps the input SocketChannel
   */
  ...
  class ConnectOptions {
    ...
    /**
     * Creates a base set of connection options. The default values for the options are:
     *
     * <pre>
     *   tcpNoDelay = false
     *   receiveBufferSize = 0
     ...
     *
     * @param tcpNoDelay if true, disable the Nagle algorithm for delayed transmissions on
     *     connection
     ...
     *
     * @param rcvBufferSize the desired size of the receive buffer, or 0 to use system defaults.
     * @return this instance
     */
     ...
     *
     * @param timeout the desired timeout value for connection initiation in milliseconds, or 0 if
     ...
     *
     * @param timeout the desired timeout value for read operations in milliseconds, or 0 if system
     ...
     *
     * @param reuseAddr if true, enable the SO_REUSEADDR option on the underlying socket
     * @return this instance
     */
   ...
   *
   * @param addr The address to which the connection should be made. It is possible for a
   *     DataChannelFactory implementation to proxy this connection through an intermediary.
   * @param connectOptions the collection of connection options to be applied to the connection.
   * @return A DataChannel connected to the the specified address.
   */
  DataChannel connect(InetSocketAddress addr, ConnectOptions connectOptions) throws IOException;
}

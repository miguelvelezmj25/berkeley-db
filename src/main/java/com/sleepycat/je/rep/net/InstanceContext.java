...
/**
 * The InstanceContext class captures contextual information for object instantiation by
 * DataChannelFactory implementations.
 */
public class InstanceContext {
   ...
   *
   * @param repNetConfig the configuration from which an instantiation is being generated.
   * @param logger a logger that can be used for logging errors or other information
   */
  ...
  /**
   * Gets the LoggerFactory that is usable by an instantiation for creation of a JE HA-friendly
   * logging object.
   *

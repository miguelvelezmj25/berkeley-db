...
/**
 * Interface to check the identity of a client based on its certificate. Implementations of this
 * interface can be configured for use by the HA service to determine whether a client connection

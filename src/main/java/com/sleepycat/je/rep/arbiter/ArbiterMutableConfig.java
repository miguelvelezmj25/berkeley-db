...
public class ArbiterMutableConfig implements Cloneable {
   ...
   * Arbiter home directory. Value should be one of the predefined java.util.logging.Level values.
   *
   * <p>
   *
   * <p>
  ...
  public ArbiterMutableConfig setFileLoggingLevel(String val) {
    Level.parse(val);
    DbConfigManager.setVal(props, EnvironmentParams.JE_FILE_LEVEL, val, false);
    return this;
  }
  ...
  public ArbiterMutableConfig setConsoleLoggingLevel(String val) {
    Level.parse(val);
    DbConfigManager.setVal(props, EnvironmentParams.JE_CONSOLE_LEVEL, val, false);
    return this;
  }
  ...
  /**
   * @hidden Set this configuration parameter. First validate the value specified for the
   *     configuration parameter; if it is valid, the value is set in the configuration. Hidden
   *     could be used to set parameters internally.
   ...
   */
  public ArbiterMutableConfig setConfigParam(String paramName, String value)

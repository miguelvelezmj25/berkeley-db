...
/**
 * @hidden SSL deferred Specifies the parameters for unencrypted communication within a replicated
 *     environment. The parameters contained here are immutable.
 */
public class ReplicationBasicConfig extends ReplicationNetworkConfig {
  ...
  /**
   * Get the channel type setting for the replication service. This configuration specifies a
   * "basic" channel type.
   *

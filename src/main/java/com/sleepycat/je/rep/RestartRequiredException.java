...
/**
 * RestartRequiredException serves as the base class for all exceptions which makes it impossible
 * for HA to proceed without some form of corrective action on the part of the user, followed by a
 * restart of the application. The corrective action may involve an increase in resources used by
 * the application, a JE configurations change, discarding cached state, etc. The error message
 * details the nature of the problem.
 */
public abstract class RestartRequiredException extends EnvironmentFailureException {
  ...
  public RestartRequiredException(
      EnvironmentImpl envImpl, EnvironmentFailureReason reason, Exception cause) {
    super(envImpl, reason, cause);
  }

  public RestartRequiredException(
      EnvironmentImpl envImpl, EnvironmentFailureReason reason, String msg) {

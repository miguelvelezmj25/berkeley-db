...
/**
 * This exception indicates that the application attempted an operation that is not permitted when
 * it is in the {@link ReplicatedEnvironment.State#REPLICA} state.
 */

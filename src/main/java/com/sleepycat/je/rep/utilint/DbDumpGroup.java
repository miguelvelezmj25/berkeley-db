...
/**
 * @hidden Dumps the contents of the replication group database. Reads the database directly, using
 *     a read only Environment.
 *     <p>For internal use only. JE users should now use com.sleepycat.je.rep.DbGroupAdmin to
...
public class DbDumpGroup {
  ...
  public void run() {
    out.println(
        "For internal use only. Consider using the public "

...
/**
 * This is an implementation of SSLAuthenticator that authenticates based on the certificate of the
 * client matching the certificate that we would use when operating as a client.
 */

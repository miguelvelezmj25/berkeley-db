...
/**
 * Encapsulates the functionality around dealing with HostPort string pairs having the format:
 *
 * <p>host[:port]
 */
public class HostPortPair {
   ...
   * @throws IllegalArgumentException via ReplicatedEnvironment and Monitor ctors.
   */

...
/**
 * An implementation of X509ExtendedKeyManager which delegates most operations to an underlying
 * implementation, but which supports explicit selection of alias.
 */
public class AliasKeyManager extends X509ExtendedKeyManager {
   ...
   * Constructor.
   *
   * @param delegateKeyManager the underlying key manager to fulfill key retrieval requests
   ...
   */
  public AliasKeyManager(
      X509ExtendedKeyManager delegateKeyManager, String serverAlias, String clientAlias) {

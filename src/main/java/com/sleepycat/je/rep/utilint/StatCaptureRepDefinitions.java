...
public class StatCaptureRepDefinitions extends StatCaptureDefinitions {
  ...
  private static final StatDefinition[] feederStats = {
  ...
  private static final StatDefinition[] replayStats = {
  ...
  private static final StatDefinition[] replicaStats = {
  ...
  private static final StatDefinition[] feedertxnStats = {
  ...
  private static final StatDefinition[] binaryProtocolStats = {
  ...
  private static final StatDefinition[] vlsnIndexStats = {
  ...
  public static StatManager.SDef[] minStats = {
    new StatManager.SDef(
        ReplayStatDefinition.GROUP_NAME, ReplayStatDefinition.MIN_COMMIT_PROCESSING_NANOS)
  };

  public static StatManager.SDef[] maxStats = {
    new StatManager.SDef(
        FeederManagerStatDefinition.GROUP_NAME, FeederManagerStatDefinition.N_MAX_REPLICA_LAG),
    new StatManager.SDef(
        ReplayStatDefinition.GROUP_NAME, ReplayStatDefinition.MAX_COMMIT_PROCESSING_NANOS),
    new StatManager.SDef(
        BinaryProtocolStatDefinition.GROUP_NAME, BinaryProtocolStatDefinition.N_MAX_GROUPED_ACKS)
  };

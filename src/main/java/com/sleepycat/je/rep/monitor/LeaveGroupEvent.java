...
/**
 * The event generated when a node leaves the group. A new instance of this event is generated each
 * time a node leaves the group.
 *
 * <p>The events is generated on a "best effort" basis. It may not be generated if the node leaving
 * the group dies before it has a chance to generate the event, for example, if the process was
 * killed, or the node was unable to communicate with the monitor due to a network problem. The
...
public class LeaveGroupEvent extends MemberChangeEvent {
  ...
  LeaveGroupEvent(
      String nodeName, String masterName, LeaveReason leaveReason, long joinTime, long leaveTime) {

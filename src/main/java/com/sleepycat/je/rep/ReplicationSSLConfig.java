...
/**
 * @hidden SSL deferred Specifies the parameters that control replication network communication
 *     within a replicated environment using SSL. The parameters contained here are immutable.
 ...
 *     construction. Except as noted, the set methods of this class perform only minimal validation
 *     of configuration values when the method is called, and value checking is deferred until the
 *     time a DataChannel factory is constructed. An IllegalArgumentException is thrown if the value
 *     is not valid for that attribute.
 *     <p>ReplicationSSLkConfig follows precedence rules similar to those of {@link
 *     EnvironmentConfig}.
 *     <ol>
 *       <li>Configuration parameters specified in {@literal <environmentHome>/je.properties} take
 *           first precedence.
 *       <li>Configuration parameters set in the ReplicationSSLConfig object used at {@code
...
public class ReplicationSSLConfig extends ReplicationNetworkConfig {
  ...
  /**
   * Configures the type of communication channel to use. Valid values for this parameter are:
   *
   * <ul>
   *   <li><code>ssl</code>
   * </ul>
   *
   * <code>ssl</code> indicates that SSL is to be used for service communication. Using SSL normally
   * provides both encryption and authentication. This option supports numerous associated
   * configuration parameters. It requires, at a minimum, that a Java keystore and associated
   * keystore password be supplied. The keystore password can be supplied using multiple methods,
   * considered in the following order:
   *
   * <p>{@link #setSSLKeyStorePasswordSource} {@link #SSL_KEYSTORE_PASSWORD_CLASS
   * je.rep.ssl.keyStorePasswordClass} {@link #setSSLKeyStorePassword} {@link #SSL_KEYSTORE_PASSWORD
   * je.rep.ssl.keyStorePassword} The <code>javax.net.ssl.keyStorePassword</code> system property
   *
   * <p>The properties supported by the supplied SSL channel factory are:
   *
   * <pre>
  ...
  /**
   * The path to the Java keystore file for SSL data channnel factories. The specified path must be
   * absolute. If this parameter is not set or has an empty value, the Java system property <code>
   * javax.net.ssl.keyStore</code> is used.
   *
   * <p>
   *
   * <table border="1">
  ...
  /**
   * The password for accessing the Java keystore file for SSL data channnel factories. If this
   * parameter is not set or has an empty value, the Java system property <code>
   * javax.net.ssl.keyStorePassword</code> is used.
   *
   * <p>
   *
   * <table border="1">
  ...
  /**
   * A class that will be instantiated in order to retrieve a password that allows access to the
   * keystore file. The class must implement the <code>com.sleepycat.je.rep.net.PasswordSource
   * </code> interface.
   *
   * <p>
   *
  ...
  /**
   * The type of the Java keystore file. This is used to determine what keystore implementation
   * should be used to manipulate the named keystore file. If set to a non-empty value, the value
   * must be a valid keystore type for the Java environment. If this parameter is not set to a
   * non-empty value, the default Java keystore type is assumed.
   *
   * <p>
   *
   * <table border="1">
  ...
  /**
   * The alias name of the preferred key for use by the service dispatcher acting in SSL server
   * mode. When not set to a non-empty value and the keystore contains multiple key options, the key
   * selection algorithm is unspecified.
   *
   * <p>
   *
   * <table border="1">
   ...
   * When not set to a non-empty value and the keystore contains multiple key options, the key
   * selection algorithm is unspecified.
   *
   * <p>
   *
  ...
  /**
   * The path to the Java truststore file for SSL data channel factories. The specified path must be
   * absolute. If this parameter is not set to a non-empty value, the Java system property <code>
   * javax.net.ssl.trustStore</code> is used.
   *
   * <p>
   *
   * <table border="1">
  ...
  /**
   * The type of the Java truststore file. This is used to determine what keystore implementation
   * should be used to manipulate the named keystore file. If set to a non-empty value, the value
   * must be a valid keystore type for the Java environment. If this parameter is not set to a
   * non-empty value, the default Java keystore type is assumed.
   *
  ...
  /**
   * The list of SSL cipher suites that are acceptable for SSL data channel factories. The cipher
   * suite list must be in comma-delimited form. If this parameter is not set to a non-empty value,
   * the Java default set of enabled cipher suites is allowed.
   *
   * <p>
   *
   * <table border="1">
  ...
  /**
   * The list of SSL protocols that are acceptable for SSL data channel factories. The protocol list
   * must be in comma-delimited form. If not specified, the default type selected is TBD: TLSv1.
   *
   * <p>
   *
   * <table border="1">
   ...
   * </table>
   */
  public static final String SSL_PROTOCOLS = EnvironmentParams.REP_PARAM_PREFIX + "ssl.protocols";

  /**
   * The specification for an SSL authenicator. The authenticator can be configured in one of the
   * following ways:
   *
   * <ul>
   *   <li><code>mirror</code>
   *   <li><code>dnmatch(</code>&lt;Regular Expression&gt;<code>)</code>
   * </ul>
   *
   * The <code>mirror</code> option causes the authenticator to check that the Distinguished
   * Name(DN) in the certificate of the incoming client connection matches the DN of the certificate
   * that this server presents when connecting as a client to another server.
   *
   * <p>The <code>dnmatch()</code> option causes the authenticator to check that the DN in the
   * certificate of the incoming client connection matches the regular expression provided in the
   * dnmatch() specification.
   *
   * <p>Do not configure both the SSL authenticator and the SSL authenticator class, or an exception
   * will be thrown during DataChannelFactory instantiation.
   *
   * <p>
   *
   * <table border="1">
  ...
  /**
   * The string identifying a class to be instantiated to check whether incoming client SSL
   * connections are to be trusted. If specified, the string must be a fully qualified Java class
   * name for a class that implements the {@link SSLAuthenticator} interface and provides a public
   * constructor with an argument list of the form ( {@link InstanceParams} ).
   *
   * <p>Do not configure both the SSL authenticator and the SSL authenticator class, or an exception
   * will be thrown during DataChannelFactory instantiation.
   *
  ...
  /**
   * The configuration to be used for verifying the certificate of a server when a connection is
   * made.
   *
   * <p>The verifier can be configured in one of the following ways:
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>The <code>hostname</code> option causes the verifier to check that the Distinguished
   * Name(DN) or one of the Subject Alternative Names in the certificate presented by the server
   * contains the hostname that was the target of the connection attempt. This assumes that server
   * certificates are unique per server.
   *
   * <p>The <code>mirror</code> option causes the verifier to check that the Distinguished Name(DN)
   * in the certificate of the server matches the DN of the certificate that this server presents to
   * incoming client connections. This assumes that all servers have equivalent certificates.
   *
   * <p>The <code>dnmatch()</code> option causes the verifier to check that the DN in the
   * certificate of the server matches the regular expression string provided in the dnmatch()
   * specification.
   *
   * <p>Do not configure both the SSL host verifier and the SSL host verifier class, or an exception
   * will be thrown during DataChannelFactory instantiation.
   *
   * <p>
   *
  ...
  /**
   * The class to be instantiated to check whether the target host of a connection initiated by a
   * client is to be trusted. If specified, the string must be a fully qualified Java class name for
   * a class that implements the <code>javax.net.ssl.HostnameVerifier</code> interface and provides
   * a public constructor with an argument list of the form ({@link InstanceParams}).
   *
   * <p>Do not configure both the SSL host verifier and the SSL host verifier class, or an exception
   * will be thrown during DataChannelFactory instantiation.
   *
  ...
  /**
   * Constructs a ReplicationSSLConfig initialized with the system default settings. Defaults are
   * documented with the string constants in this class.
   */
  public ReplicationSSLConfig() {}

  /**
   * Creates an ReplicationSSLConfig which includes the properties specified in the properties
   * parameter.
   *
  ...
  public void setSSLKeyStoreVoid(String filename) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_KEYSTORE_FILE, filename, validateParams);
  }
  ...
  public void setSSLKeyStoreTypeVoid(String keyStoreType) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_KEYSTORE_TYPE, keyStoreType, validateParams);
  }
  ...
  public void setSSLKeyStorePasswordVoid(String password) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_KEYSTORE_PASSWORD, password, validateParams);
  }

  /**
   * Returns the name of a class that should be instantiated to retrieve the password for the Java
   * KeyStore file.
   *
  ...
  public String getSSLKeyStorePasswordClass() {
    ...
    return DbConfigManager.getVal(props, RepParams.SSL_KEYSTORE_PASSWORD_CLASS);
  }

  /**
   * Sets the name of a class that should be instantiated to retrieve the password for the Java
   * KeyStore file.
   *
  ...
  public void setSSLKeyStorePasswordClassVoid(String className) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_KEYSTORE_PASSWORD_CLASS, className, validateParams);
  }
  ...
  public String getSSLKeyStorePasswordParams() {
    ...
    return DbConfigManager.getVal(props, RepParams.SSL_KEYSTORE_PASSWORD_PARAMS);
  }
  ...
  public void setSSLKeyStorePasswordParamsVoid(String params) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_KEYSTORE_PASSWORD_PARAMS, params, validateParams);
  }

  /**
   * Returns the Java KeyStore alias associated with the key that should be used to accept incoming
   * SSL connections.
   *
  ...
  /**
   * Sets the alias associated with the key in the Java KeyStore file to be used when accepting
  ...
  public void setSSLServerKeyAliasVoid(String alias) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_SERVER_KEY_ALIAS, alias, validateParams);
  }

  /**
   * Returns the Java KeyStore alias associated with the key that should be used when initiating SSL
   * connections .
   *
   * @return the KeyStore alias
   */
  ...
  /**
   * Sets the alias associated with the key in the Java KeyStore file to be used when initiating SSL
   * connections.
   *
   * @param alias the KeyStore alias
   * @return this
  ...
  public void setSSLClientKeyAliasVoid(String alias) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_CLIENT_KEY_ALIAS, alias, validateParams);
  }
  ...
  public void setSSLTrustStoreVoid(String filename) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_TRUSTSTORE_FILE, filename, validateParams);
  }
  ...
  public void setSSLTrustStoreTypeVoid(String trustStoreType) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_TRUSTSTORE_TYPE, trustStoreType, validateParams);
  }
  ...
  public void setSSLCipherSuitesVoid(String cipherSuites) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_CIPHER_SUITES, cipherSuites, validateParams);
  }
  ...
  public void setSSLProtocolsVoid(String protocols) {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_PROTOCOLS, protocols, validateParams);
  }

  /**
   * Returns the SSLAuthenticator configuration to be used for authenticating incoming client
   * connections.
   *
   ...
   *
   * <p>See {@link #SSL_AUTHENTICATOR} for a complete description of this parameter.
   *
   * @param authenticator the authentication configuration to use
   * @return this
   * @throws IllegalArgumentException if the authenticator specification is not syntactically valid
   */
  ...
  public void setSSLAuthenticatorVoid(String authenticator) throws IllegalArgumentException {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_AUTHENTICATOR, authenticator, validateParams);
  }
  ...
  public String getSSLAuthenticatorClass() {
    ...
    return DbConfigManager.getVal(props, RepParams.SSL_AUTHENTICATOR_CLASS);
  }

  /**
   * Sets the authenticator class to be instantiated for creation of new SSL Authenticator
   * instances.
   *
  ...
  public void setSSLAuthenticatorClassVoid(String authenticatorClass)
    ...
    DbConfigManager.setVal(
        props, RepParams.SSL_AUTHENTICATOR_CLASS, authenticatorClass, validateParams);
  }
  ...
  public String getSSLAuthenticatorParams() {
    ...
    return DbConfigManager.getVal(props, RepParams.SSL_AUTHENTICATOR_PARAMS);
  }

  /**
   * Sets the Authenticator parameters to be passed to the SSL server Authenticator class when
   * instantiated.
   *
  ...
  public void setSSLAuthenticatorParamsVoid(String authenticatorParams) {
    ...
    DbConfigManager.setVal(
        props, RepParams.SSL_AUTHENTICATOR_PARAMS, authenticatorParams, validateParams);
  }

  /**
   * Returns the HostnameVerifier factory class to be used for creating new host verifier instances
   * for client-mode operation
   *
   * @return the HostnameVerifier factory class name, if configured
   */
  public String getSSLHostVerifier() {

    return DbConfigManager.getVal(props, RepParams.SSL_HOST_VERIFIER);
  }

  /**
   * Sets the configuration to be used for verifying the certificate of a server when a connection
   * is made.
   *
   * <p>See {@link #SSL_HOST_VERIFIER} for a complete description of this parameter.
   *
  ...
  public void setSSLHostVerifierVoid(String hostVerifier) throws IllegalArgumentException {
    ...
    DbConfigManager.setVal(props, RepParams.SSL_HOST_VERIFIER, hostVerifier, validateParams);
  }
  ...
  public String getSSLHostVerifierClass() {
    ...
    return DbConfigManager.getVal(props, RepParams.SSL_HOST_VERIFIER_CLASS);
  }

  /**
   * Sets the host verifier class to be instantiated for creation of new SSL host verifier
   * instances.
   *
  ...
  public void setSSLHostVerifierClassVoid(String hostVerifierClass) {
    ...
    DbConfigManager.setVal(
        props, RepParams.SSL_HOST_VERIFIER_CLASS, hostVerifierClass, validateParams);
  }

  /**
   * Returns the SSLHostVerifier parameters to be used for creating new host verifier instances for
   * operation in client mode, if needed.
   *
   * @return the SSLHostVerifier factory params name, if configured
   */
  public String getSSLHostVerifierParams() {

    return DbConfigManager.getVal(props, RepParams.SSL_HOST_VERIFIER_PARAMS);
  }

  /**
   * Sets the host verifier parameters to be passed to the SSL host verifier class when
   * instantiated.
   *
  ...
  public void setSSLHostVerifierParamsVoid(String hostVerifierParams) {
    ...
    DbConfigManager.setVal(
        props, RepParams.SSL_HOST_VERIFIER_PARAMS, hostVerifierParams, validateParams);
  }
  ...
  /**
   * Sets the password source for KeyStore access by the SSL implementation. If not set to a
   * non-empty value, the SSL implementation uses the {@link #SSL_KEYSTORE_PASSWORD
   * je.rep.ssl.keyStorePassword} property instead. This setting is not included in the serialized
   * representation.
   */
  ...
  /**
   * @hidden Enumerate the subset of configuration properties that are intended to control network
   *     access.
   */

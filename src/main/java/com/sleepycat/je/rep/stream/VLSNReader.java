...
/**
 * The VLSNReader returns picks out replicated log entries from the log. It works in tandem with the
 * VLSNIndex, using vlsn->lsn mappings if those are available, and otherwise scanning the log for
 * replicated entries.
 *
 * <p>A VLSNReader is not thread safe, and can only be used serially.
 */

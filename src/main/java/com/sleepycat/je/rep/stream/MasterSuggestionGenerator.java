 ...
 *
 * <p>A more sophisticated version may contact other replica nodes to see if it has sufficient
 * connectivity to implement the commit policy in effect for the Replication Group. KIS for now.
 */
public class MasterSuggestionGenerator implements Acceptor.SuggestionGenerator {
   ...
   *
   * <p>It will submit a Proposal with a premptive ranking so that it's guaranteed to be the
   * selected as the master at the next election.
   *

...
public class ProposerStatDefinition {
  ...
  public static StatDefinition PHASE1_ARBITER =
      new StatDefinition(
          "phase1Arbiter",
          "Number of times Phase 1 ended due to Arbiter " + "having highest VLSN.");

  public static StatDefinition PHASE1_NO_QUORUM =
      new StatDefinition(
          "phase1NoQuorum",
          "Number of times Phase 1 ended with insufficient votes for a " + "quorum.");
  ...
  public static StatDefinition PHASE2_NO_QUORUM =
      new StatDefinition(
          "phase2NoQuorum",
          "Number of times Phase 2 ended with insufficient votes for a " + "quorum.");
  ...
  public static StatDefinition PROMISE_COUNT =
      new StatDefinition("promiseCount", "Number of promises made by Acceptors in phase 1.");
}

...
/**
 * Class represents the identity of a Master as a subclass of a StringValue that can be used during
...
public class MasterValue extends StringValue {
   ...
   */
  public static ValueParser getParser() {
    return masterValueParser;
  }

  private static final ValueParser masterValueParser =
      new ValueParser() {

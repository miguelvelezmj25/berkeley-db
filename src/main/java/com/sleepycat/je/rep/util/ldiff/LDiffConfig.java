...
public class LDiffConfig {
   ...
   *
   * @return the maximum number of errors to analyze before throwing MismatchException.
   */
  ...
  /**
   * Configure the maximum number of errors to be analyzed before ending the LDiff operation. A
   * value of zero forces the algorithm to run to completion. The default value is 0.
   *
   * @param max the maximum number of errors to be analyzed before ending the LDiff operation.
   */
   ...
   *
   * @return true if an LDiff object will provide detailed analysis about diff failures.
   */
  ...
  /**
   * Configure an LDiff object to provide detailed analysis about diff failures. The default value
   * is false.
   *
   * @param analysis if true, provides detailed analysis about the reason why the diff failed. The
   *     detailed analysis can be time consuming.
   */
  ...
  /**
   * Configure the number of records to include in each block analyzed by the LDiff operation. The
   * default is 10240.
   *
   * @param size the number of records to include in each block analyzed by the LDiff operation.
   */
  ...
  /**
   * Return whether or not the operation will wait for the remote service to become available if the
   * remote service is busy.
   *
   * @return true if the LDiff operation will block until the remote service becomes available
   */
  ...
  /**
   * Return the maximum number of times the operation will attempt to connect to the remote service
   * before aborting. A value of -1 means the operation will never abort.
   *
   * @return the maximum number of times the operation will attempt to connect to the remote service
   *     before aborting.
   */
   ...
   *
   * @return the amount of time, in milliseconds, between reconnection attempts
   */
  ...
  /**
   * Configure whether or not the operation should wait for the remote service to become available,
   * if the remote service is busy.
   *
   * @param wait if true, the LDiff operation will block until the remote node is available
   * @param maxAttempts the number of times to attempt connecting to the service before aborting.
   *     Pass -1 to never abort.
   * @param delay the number of milliseconds to wait between connection attempts.
   */
   ...
   *
   * @param verbose if true, the LDiff operation will output information as it compares databases
   */

 ...
 *     other BDBJE packages but that are not part of the public api available to applications.
 */
public class RepInternal {
   ...
   * called instead.
   *
   * @return the non-null underlying RepImpl, or null if the env has been closed.
   */
   ...
   *
   * <p>This method is called to access the underlying RepImpl when an env is expected to be open,
   * to guard against NPE when the env has been closed.
   *
   * <p>This method does not check whether the env is valid.
   *
  ...
  public static ReplicationConfig makeReplicationConfig(Properties props, boolean validateParams)
   ...
   * group.
   */
  public static ReplicatedEnvironment createDetachedEnv(
      File envHome, ReplicationConfig repConfig, EnvironmentConfig envConfig)
      throws DatabaseException {

    return new ReplicatedEnvironment(
        envHome, repConfig, envConfig, null, QuorumPolicy.SIMPLE_MAJORITY, false, null);
  }
   ...
   */
  public static ReplicatedEnvironment createInternalEnvHandle(
      File envHome, ReplicationConfig repConfig, EnvironmentConfig envConfig)
      throws DatabaseException {

    return new ReplicatedEnvironment(envHome, repConfig, envConfig, null, null, false, null);
  }

  /** Proxy to ReplicationMutableConfig.validateParams. */
  public static void disableParameterValidation(ReplicationMutableConfig config) {
  ...
  public static void setAllowConvert(
      final ReplicationConfig repConfig, final boolean allowConvert) {

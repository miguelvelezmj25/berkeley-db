...
public class VLSNIndexStatDefinition {
  ...
  public static final String N_HITS_NAME = "nHits";
  public static final String N_HITS_DESC = "Number of hits to the VLSN index cache";
  public static final StatDefinition N_HITS = new StatDefinition(N_HITS_NAME, N_HITS_DESC);

  public static final String N_MISSES_NAME = "nMisses";
  public static final String N_MISSES_DESC =
      "Number of log entry misses upon access to the VLSN index cache. Upon"
          ...
          + "or the log file.";
  public static final StatDefinition N_MISSES = new StatDefinition(N_MISSES_NAME, N_MISSES_DESC);

  public static final String N_HEAD_BUCKETS_DELETED_NAME = "nHeadBucketsDeleted";
  ...
  public static final StatDefinition N_HEAD_BUCKETS_DELETED =
      new StatDefinition(N_HEAD_BUCKETS_DELETED_NAME, N_HEAD_BUCKETS_DELETED_DESC);

  public static final String N_TAIL_BUCKETS_DELETED_NAME = "nTailBucketsDeleted";
  ...
  public static final StatDefinition N_TAIL_BUCKETS_DELETED =
      new StatDefinition(N_TAIL_BUCKETS_DELETED_NAME, N_TAIL_BUCKETS_DELETED_DESC);

  public static final String N_BUCKETS_CREATED_NAME = "nBucketsCreated";
  ...
  public static final StatDefinition N_BUCKETS_CREATED =
      new StatDefinition(N_BUCKETS_CREATED_NAME, N_BUCKETS_CREATED_DESC);
}

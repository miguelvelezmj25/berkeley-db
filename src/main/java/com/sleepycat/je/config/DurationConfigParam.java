...
/**
 * A JE configuration parameter with a duration integer value in milliseconds. The String format is
 * described under Time Duration Properties in the EnvironmentConfig javadoc.
 */

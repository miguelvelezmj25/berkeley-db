...
public class EnvironmentParams {
   ...
   *
   * <p>If true, even when recovery is not run (see ENV_RECOVERY) by a utility, the btree and dup
   * comparators will be instantiated. Set to true by utilities such as DbScavenger that need
   * comparators in spite of not needing recovery.
   */
   ...
   * Used by utilities, not exposed in the API.
   *
   * <p>If true, an environment is created with recovery and the related daemon threads are enabled.
   */
  ...
  public static final BooleanConfigParam ENV_RECOVERY_FORCE_CHECKPOINT =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_RECOVERY_FORCE_CHECKPOINT,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam ENV_RUN_INCOMPRESSOR =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_RUN_IN_COMPRESSOR,
          true, // default
          true, // mutable
          false); // forReplication
  ...
  /**
   * The amount of time to wait for the eviction pool to terminate, in order to create a clean
   * shutdown. An intentionally unadvertised parameter, of use mainly for unit test cleanup.
   */
  public static final DurationConfigParam EVICTOR_TERMINATE_TIMEOUT =
      new DurationConfigParam(
          "je.env.terminateTimeout",
          "1 ms", // min
          "60 s", // max
          "10 s", // default
          true, // mutable
  ...
  public static final BooleanConfigParam ENV_RUN_CHECKPOINTER =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_RUN_CHECKPOINTER,
          true, // default
          true, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam ENV_CHECK_LEAKS =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_CHECK_LEAKS,
          true, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam ENV_FORCED_YIELD =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_FORCED_YIELD,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam ENV_INIT_TXN =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_IS_TRANSACTIONAL,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam ENV_RDONLY =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_READ_ONLY,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam ENV_FAIR_LATCHES =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_FAIR_LATCHES,
          false, // default
          false, // mutable
          false); // forReplication

  /**
   * Not part of the public API. As of 3.3, is true by default. As of 6.0, it is no longer used (and
   * latches are always shared when possible). The param is left in place just to avoid errors from
   * config settings.
   */
  ...
  public static final DurationConfigParam ENV_LATCH_TIMEOUT =
      new DurationConfigParam(
          EnvironmentConfig.ENV_LATCH_TIMEOUT,
          "1 ms", // min
          null, // max
          "5 min", // default
          false, // mutable
  ...
  /**
   * Hidden (for now) parameter to control the assumed maximum length that a lock may be held. It is
   * used to determine when a record might expire during a transaction, so we can avoid extra
   * locking or checking for locks when a record should not expire during the current transaction.
   */
  public static final DurationConfigParam ENV_TTL_MAX_TXN_TIME =
      new DurationConfigParam(
          "je.env.ttlMaxTxnTime",
          null, // min
          null, // max
          "24 h", // default
          false, // mutable
  ...
  /**
   * Hidden (for now) parameter to determine the amount added to the expirationTime of a record to
   * determine when to purge it, in the cleaner. The goal is to ensure (disregarding clock changes)
   * that when a record is locked, its LN will not be purged. We lock the record before fetching the
   * LN, so delaying the purge of the LN a little should prevent purging a locked LN due to thread
   * scheduling issues.
   */
  public static final DurationConfigParam ENV_TTL_LN_PURGE_DELAY =
      new DurationConfigParam(
          "je.env.ttlLnPurgeDelay",
          null, // min
          null, // max
          "5 s", // default
          false, // mutable
  ...
  /**
   * Hidden (for now) parameter to allow user key/data values to be included in exception messages,
   * log messages, etc. For example, when this is set to true, the SecondaryReferenceException
   * message will include the primary key and secondary key.
   */
  ...
  public static final IntConfigParam NUM_LOG_BUFFERS =
      new IntConfigParam(
          EnvironmentConfig.LOG_NUM_BUFFERS,
          2, // min
          null, // max
  ...
  public static final IntConfigParam LOG_N_DATA_DIRECTORIES =
      new IntConfigParam(
          EnvironmentConfig.LOG_N_DATA_DIRECTORIES,
          0, // min
          256, // max
          0, // default
          false, // mutable
  ...
  public static final BooleanConfigParam LOG_CHECKSUM_READ =
      new BooleanConfigParam(
          EnvironmentConfig.LOG_CHECKSUM_READ,
          true, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam LOG_VERIFY_CHECKSUMS =
      new BooleanConfigParam(
          EnvironmentConfig.LOG_VERIFY_CHECKSUMS,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam LOG_MEMORY_ONLY =
      new BooleanConfigParam(
          EnvironmentConfig.LOG_MEM_ONLY,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam LOG_FILE_CACHE_SIZE =
      new IntConfigParam(
          EnvironmentConfig.LOG_FILE_CACHE_SIZE,
          3, // min
          null, // max
          100, // default
          false, // mutable
  ...
  /**
   * This is experimental and pending performance tests. Javadoc and change log are commented out
   * below, and can be used if we decide to use this.
   */
  ...
  public static final BooleanConfigParam LOG_DETECT_FILE_DELETE =
      new BooleanConfigParam(
          EnvironmentConfig.LOG_DETECT_FILE_DELETE,
          true, // default
          false, // mutable
          false); // forReplication
  ...
  /**
   * The size in MiB to be read sequentially at the end of the log in order to warm the file system
   * cache.
   *
   * <p>Making use of sequential reads to warm the file system cache has the benefit of reducing
   * random reads caused by CRUD operations, and thereby increasing throughput and latency for these
   * operations. This is especially true during the initial period after opening an Environment,
   * when CRUD operations must fetch Btree internal nodes from the file system in order to populate
   * the JE cache. The fetches due to JE cache misses typically cause random reads. Often the Btree
   * internal nodes that are needed appear close to the end of the log because they were written
   * fairly recently by checkpoints, and this is why warming the cache with the data at the end of
   * the log is often beneficial.
   *
   * <p>The warm-up occurs concurrently with recovery when an Environment is opened. It may finish
   * before recovery finishes, or continue after recovery finishes when recovery is brief. In the
   * latter case, the warm-up is concurrent with the application's CRUD operations. A dedicated
   * thread is used for the warm-up, and this thread is destroyed when warm-up is complete.
   *
   * <p>Recovery itself will perform at least a partial warm-up implicitly, since it reads the log
   * (sequentially), and in fact it may read more than the configured warm-up size. The warm-up
   * thread will only read the portion of the log not being read by recovery, and only when the
   * warm-up size is larger than the size read by recovery (i.e., it reads the difference between
   * these two sizes).
   *
   * <p>The size read by recovery is dependent on whether the Environment was previously closed
   * cleanly (a crash did not occur and the application called Environment.close), and on the size
   * of the last complete checkpoint. When the environment is closed cleanly with a small
   * checkpoint, recovery will only read a small portion of the log, and in this case the additional
   * reads performed by the warm-up thread can be very beneficial.
   *
   * <p>If the warm-up size is larger than the amount of memory available to the file system cache,
   * then the warm-up may be counter productive, although TODO: change text below or change default
   * to 1024 the default warm-up size (1 GiB) was chosen to avoid this problem in most cases.
   * Applications are advised to change the warm-up size based on knowledge of the amount of
   * physical memory on the machine and how much is expected to be available as file system cache.
   * The warm-up may be disabled by setting the warm-up size to zero, although of course recovery
   * will continue to do some amount of warm-up implicitly.
   *
   * <p>The warm-up thread performs read operations using a single buffer and it reads as much as
   * will fit in the buffer at a time. The size of the buffer, and therefore the maximum size of
   * each read, is {@link #LOG_FILE_WARM_UP_READ_SIZE}. Files are read in the reverse of the order
   * they were written.
   *
   * <p>
   *
  ...
  /**
   * The read buffer size for warming the file system cache; see {@link #LOG_FILE_WARM_UP_SIZE}.
   *
   * <p>Because the warm-up can be concurrent with application CRUD operations, it is important that
   * a large buffer size be used for reading the data files during the warm-up. That way, the
   * warm-up is performed using sequential reads to a large degree, even though CRUD operations may
   * cause some random I/O. Sequential reads are required to obtain the performance benefit of the
   * warm-up.
   *
   * <p>Note that this buffer is allocated outside of the JE cache, so the Java heap size must be
   * set accordingly.
   *
   * <p>The default value, 10 MiB, is designed to reduce random I/O to some degree. It should be
   * made larger to perform the warm-up more quickly, especially if there are many application
   * threads performing CRUD operations. In our tests, using a value of 100 MiB minimized the time
   * to complete the warm-up while 20 threads performed CRUD operations.
   *
   * <p>
   *
   * <table border="1">
   ...
   * </table>
   *
   * public static final String LOG_FILE_WARM_UP_READ_SIZE = "je.log.fileWarmUpReadSize";
   */
  ...
  */
  ...
  public static final DurationConfigParam LOG_GROUP_COMMIT_INTERVAL =
      new DurationConfigParam(
          EnvironmentConfig.LOG_GROUP_COMMIT_INTERVAL,
          "0 ns", // min
          null, // max
          "0 ns", // default
          false, // mutable
  ...
  public static final IntConfigParam LOG_GROUP_COMMIT_THRESHOLD =
      new IntConfigParam(
          EnvironmentConfig.LOG_GROUP_COMMIT_THRESHOLD,
          0, // min
          null, // max
          0, // default
          false, // mutable
  ...
  public static final BooleanConfigParam LOG_USE_ODSYNC =
      new BooleanConfigParam(
          EnvironmentConfig.LOG_USE_ODSYNC,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam LOG_USE_WRITE_QUEUE =
      new BooleanConfigParam(
          EnvironmentConfig.LOG_USE_WRITE_QUEUE,
          true, // default
          false, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam LOG_WRITE_QUEUE_SIZE =
      new IntConfigParam(
          EnvironmentConfig.LOG_WRITE_QUEUE_SIZE,
          1 << 12, // min (4KB)
          1 << 28, // max (32MB)
          1 << 20, // default (1MB)
          false, // mutable
  ...
  private static final LongConfigParam LOG_CHUNKED_NIO =
      new LongConfigParam(
          EnvironmentConfig.LOG_CHUNKED_NIO,
          0L, // min
          1L << 26, // max (64M)
   ...
   *     <p>Optimize cleaner operation for temporary deferred write DBs.
   */
  ...
  public static final BooleanConfigParam ENV_RUN_VERIFIER =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_RUN_VERIFIER,
          true, // default
          true, // mutable
          false); // forReplication
  ...
  public static final ConfigParam VERIFY_SCHEDULE =
      new ConfigParam(
          EnvironmentConfig.VERIFY_SCHEDULE,
          "0 0 * * *", // default
          true, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam VERIFY_OBSOLETE_RECORDS =
      new BooleanConfigParam(
          EnvironmentConfig.VERIFY_OBSOLETE_RECORDS,
          false, // default
          true, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam NODE_MAX_DUPTREE =
      new IntConfigParam(
          EnvironmentConfig.NODE_DUP_TREE_MAX_ENTRIES,
          4, // min
          32767, // max
          128, // default
          false, // mutable
  ...
  private static final IntConfigParam BIN_MAX_DELTAS =
      new IntConfigParam(
          EnvironmentConfig.TREE_MAX_DELTA,
          0, // min
          100, // max
          10, // default
          false, // mutable
  ...
  public static final IntConfigParam BIN_DELTA_PERCENT =
      new IntConfigParam(
          EnvironmentConfig.TREE_BIN_DELTA,
          0, // min
          75, // max
          25, // default
          false, // mutable
  ...
  public static final IntConfigParam COMPRESSOR_RETRY =
      new IntConfigParam(
          EnvironmentConfig.COMPRESSOR_DEADLOCK_RETRY,
          0, // min
          Integer.MAX_VALUE, // max
          3, // default
          false, // mutable
   ...
   *     <p>When eviction happens, the evictor will push memory usage to this percentage of
   *     je.maxMemory.
   */
   ...
   *     <p>The evictor percentage of total nodes to scan per wakeup.
   */
   ...
   *     <p>The evictor percentage of scanned nodes to evict per wakeup.
   */
  private static final IntConfigParam EVICTOR_EVICTION_BATCH_PERCENTAGE =
      new IntConfigParam(
  ...
  private static final IntConfigParam EVICTOR_RETRY =
      new IntConfigParam(
          EnvironmentConfig.EVICTOR_DEADLOCK_RETRY,
          0, // min
          Integer.MAX_VALUE, // max
          3, // default
          false, // mutable
  ...
  /**
   * If true (the default), use a 2-level LRU policy that aims to keep dirty BTree nodes in memory
   * at the expense of potentially hotter clean nodes. Specifically, a node that is selected for
   * eviction from level-1 will be moved to level-2 if it is dirty. Nodes in level-2 are considered
   * for eviction only after all nodes in level-1 have been considered. Dirty nodes that are in
   * level-2 are moved back to level-1 when they get cleaned.
   *
   * <p>This parameter applies to the new evictor only.
   *
   * <p>
   *
   * <table border="1">
  ...
  public static final BooleanConfigParam ENV_EXPIRATION_ENABLED =
      new BooleanConfigParam(
          EnvironmentConfig.ENV_EXPIRATION_ENABLED,
          true, // default
          true, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam CHECKPOINTER_RETRY =
      new IntConfigParam(
          EnvironmentConfig.CHECKPOINTER_DEADLOCK_RETRY,
          0, // min
          Integer.MAX_VALUE, // max
          3, // default
          false, // mutable
  ...
  public static final DurationConfigParam CLEANER_WAKEUP_INTERVAL =
      new DurationConfigParam(
          EnvironmentConfig.CLEANER_WAKEUP_INTERVAL,
          "0", // min
          "1 h", // max
          "10 s", // default
          true, // mutable
  ...
  public static final BooleanConfigParam CLEANER_FETCH_OBSOLETE_SIZE =
      new BooleanConfigParam(
          EnvironmentConfig.CLEANER_FETCH_OBSOLETE_SIZE,
          false, // default
          true, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam CLEANER_DEADLOCK_RETRY =
      new IntConfigParam(
          EnvironmentConfig.CLEANER_DEADLOCK_RETRY,
          0, // min
          Integer.MAX_VALUE, // max
          3, // default
          true, // mutable
  ...
  public static final BooleanConfigParam CLEANER_REMOVE =
      new BooleanConfigParam(
          EnvironmentConfig.CLEANER_EXPUNGE,
          true, // default
          true, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam CLEANER_USE_DELETED_DIR =
      new BooleanConfigParam(
          EnvironmentConfig.CLEANER_USE_DELETED_DIR,
          false, // default
          true, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam CLEANER_MIN_AGE =
      new IntConfigParam(
          EnvironmentConfig.CLEANER_MIN_AGE,
          1, // min
          1000, // max
          2, // default
          true, // mutable
  ...
  /** @deprecated Retained here only to avoid errors in old je.properties files. */
  ...
  public static final IntConfigParam CLEANER_READ_SIZE =
      new IntConfigParam(
          EnvironmentConfig.CLEANER_READ_SIZE,
          128, // min
          null, // max
          0, // default
          true, // mutable
  ...
  public static final DurationConfigParam DOS_PRODUCER_QUEUE_TIMEOUT =
      new DurationConfigParam(
          EnvironmentConfig.DOS_PRODUCER_QUEUE_TIMEOUT,
          "0", // min
          "75 min", // max
          "10 seconds", // default
          true, // mutable
   ...
   *
   * <p>If true, the cleaner tracks and stores detailed information that is used to decrease the
   * cost of cleaning.
   */
   ...
   * Not part of public API.
   *
   * <p>If true (the default), data expires gradually over an hour or day time period, preventing
   * spikes in cleaning after hour/day boundaries. This might be set to false for debugging.
   */
   ...
   * Not part of public API.
   *
   * <p>Used to determine when to perform two-pass cleaning.
   *
   ...
   * <p>Used to determine when to perform two-pass cleaning.
   *
   * <p>Two-pass cleaning is used when: 1. the file's maximum utilization is greater than {@link
   * #CLEANER_TWO_PASS_THRESHOLD}, and 2. the difference between the minimum and maximum utilization
   * of a file is greater than or equal to than {@link #CLEANER_TWO_PASS_GAP}.
   *
   * <p>After pass one, pass two is performed only if the recalculated utilization is greater than
   * or equal to {@link #CLEANER_TWO_PASS_THRESHOLD}.
   *
   * <p>When this parameter is zero, the default, the value used is {@link
   * EnvironmentConfig#CLEANER_MIN_UTILIZATION} minus five.
   *
   * @see EnvironmentStats#getNCleanerTwoPassRuns()
   */
  ...
  public static final IntConfigParam CLEANER_DETAIL_MAX_MEMORY_PERCENTAGE =
      new IntConfigParam(
          EnvironmentConfig.CLEANER_DETAIL_MAX_MEMORY_PERCENTAGE,
          1, // min
          90, // max
          2, // default
          true, // mutable
   ...
   *
   * <p>If true, detail information is discarded that was added by earlier versions of JE
   * (specifically 2.0.42 and 2.0.54) if it may be invalid. This may be set to false for increased
   * performance when those version of JE were used but LockMode.RMW was never used.
   */
  ...
  public static final ConfigParam CLEANER_FORCE_CLEAN_FILES =
      new ConfigParam(
          EnvironmentConfig.CLEANER_FORCE_CLEAN_FILES,
          "", // default
          true, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam CLEANER_UPGRADE_TO_LOG_VERSION =
      new IntConfigParam(
          EnvironmentConfig.CLEANER_UPGRADE_TO_LOG_VERSION,
          -1, // min
          null, // max
          0, // default
          false, // mutable
  ...
  /** @deprecated Retained here only to avoid errors in old je.properties files. */
  private static final BooleanConfigParam CLEANER_FOREGROUND_PROACTIVE_MIGRATION =
      new BooleanConfigParam(
  ...
  public static final DurationConfigParam LOCK_DEADLOCK_DETECT_DELAY =
      new DurationConfigParam(
          EnvironmentConfig.LOCK_DEADLOCK_DETECT_DELAY,
          "0", // min
          "75 min", // max
          "0", // default
          false, // mutable
  ...
  public static final BooleanConfigParam TXN_SERIALIZABLE_ISOLATION =
      new BooleanConfigParam(
          EnvironmentConfig.TXN_SERIALIZABLE_ISOLATION,
          false, // default
          false, // mutable
          false); // forReplication
  ...
  public static final BooleanConfigParam TXN_DUMPLOCKS =
      new BooleanConfigParam(
          EnvironmentConfig.TXN_DUMP_LOCKS,
          false, // default
          true, // mutable
          false); // forReplication
  ...
  public static final DurationConfigParam STARTUP_DUMP_THRESHOLD =
      new DurationConfigParam(
          EnvironmentConfig.STARTUP_DUMP_THRESHOLD,
          "0", // min
          null, // max
          "5 min", // default
          false, // mutable
  ...
  public static final BooleanConfigParam STATS_COLLECT =
      new BooleanConfigParam(
          EnvironmentConfig.STATS_COLLECT,
          true, // default
          true, // mutable
          false); // forReplication
  ...
  public static final IntConfigParam STATS_FILE_ROW_COUNT =
      new IntConfigParam(
          EnvironmentConfig.STATS_FILE_ROW_COUNT,
          2, // min
          Integer.MAX_VALUE, // max
          1440, // default
          true, // mutable
  ...
  public static final IntConfigParam STATS_MAX_FILES =
      new IntConfigParam(
          EnvironmentConfig.STATS_MAX_FILES,
          1, // min
          Integer.MAX_VALUE, // max
          10, // default
          true, // mutable
  ...
  public static final DurationConfigParam STATS_COLLECT_INTERVAL =
      new DurationConfigParam(
          EnvironmentConfig.STATS_COLLECT_INTERVAL,
          "1 s", // min
          null, // max
          "1 min", // default
          true, // mutable
  ...
  public static final ConfigParam STATS_FILE_DIRECTORY =
      new ConfigParam(
          EnvironmentConfig.STATS_FILE_DIRECTORY,
          "", // default
          false, // mutable
          false); // forReplication

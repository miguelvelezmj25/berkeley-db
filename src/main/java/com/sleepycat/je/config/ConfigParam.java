...
/**
 * A ConfigParam embodies the metadata about a JE configuration parameter: the parameter name,
 * default value, and a validation method.
 *
 * <p>Validation can be done in the scope of this parameter, or as a function of other parameters.
 */
public class ConfigParam {
   ...
   */
  public ConfigParam(
      String configName, String configDefault, boolean mutable, boolean forReplication)
  ...
  /**
   * Validate your value. (No default validation for strings.) May be overridden for (e.g.)
   * Multi-value params.
   *

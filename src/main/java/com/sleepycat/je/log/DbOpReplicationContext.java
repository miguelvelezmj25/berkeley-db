...
/**
 * This subclass of ReplicationContext adds information specific to database operations to the
 * replication context passed from operation-aware code down the the logging layer. It's a way to
 * transport enough information though the NameLNLogEntry to logically replicate database
 * operations.
 */

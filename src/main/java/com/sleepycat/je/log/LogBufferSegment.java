...
/** LogBufferSegment is used by a writer to access a portion of a LogBuffer. */
class LogBufferSegment {
  ...
  /**
   * Copies the data into the underlying LogBuffer and decrements the LogBuffer pin count.
   *
   * @param dataToCopy data to copy into the underlying LogBuffer.
   */

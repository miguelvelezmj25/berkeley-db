...
/**
 * This is a debugging utility which implements the unadvertised DbPrintLog -vd option, which
 * displays VLSN distribution in a log. Here's a sample of the output. This is used to analyze log
 * cleaner barrier behavior.
 *
 * <p>... 3 files file 0xb6 numRepRecords = 9 firstVLSN = 1,093,392 lastVLSN = 1,093,400 file 0xb7
 * numRepRecords = 4 firstVLSN = 1,093,401 lastVLSN = 1,093,404 ... 3 files file 0xbb numRepRecords
 * = 1 firstVLSN = 1,093,405 lastVLSN = 1,093,405 file 0xbc numRepRecords = 1 firstVLSN = 1,093,406
 * lastVLSN = 1,093,406 ... 1 files file 0xbe numRepRecords = 1 firstVLSN = 1,093,407 lastVLSN =
 * 1,093,407 file 0xbf numRepRecords = 2 firstVLSN = 1,093,408 lastVLSN = 1,093,409 file 0xc0
 * numRepRecords = 7 firstVLSN = 1,093,410 lastVLSN = 1,093,416 ... 0 files at end First file: 0x0
 * Last file: 0xc0
 */
public class VLSNDistributionReader extends DumpFileReader {
  ...
  /**
   * Count the number of vlsns in the file, along with the first and last vlsn. Display this when
   * the log reader moves to a new file. .
   */
  @Override

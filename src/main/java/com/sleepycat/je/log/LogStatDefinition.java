...
public class LogStatDefinition {
  ...
  public static final String GRPCOMMITMGR_GROUP_DESC = "GrpCommitManager statistics";

  /* The following stat definitions are used in FileManager. */
  public static final String FILEMGR_RANDOM_READS_NAME = "nRandomReads";
  ...
  public static final StatDefinition FILEMGR_RANDOM_READS =
      new StatDefinition(FILEMGR_RANDOM_READS_NAME, FILEMGR_RANDOM_READS_DESC);

  public static final String FILEMGR_RANDOM_WRITES_NAME = "nRandomWrites";
  ...
  public static final StatDefinition FILEMGR_RANDOM_WRITES =
      new StatDefinition(FILEMGR_RANDOM_WRITES_NAME, FILEMGR_RANDOM_WRITES_DESC);

  public static final String FILEMGR_SEQUENTIAL_READS_NAME = "nSequentialReads";
  ...
  public static final StatDefinition FILEMGR_SEQUENTIAL_READS =
      new StatDefinition(FILEMGR_SEQUENTIAL_READS_NAME, FILEMGR_SEQUENTIAL_READS_DESC);

  public static final String FILEMGR_SEQUENTIAL_WRITES_NAME = "nSequentialWrites";
  ...
  public static final StatDefinition FILEMGR_SEQUENTIAL_WRITES =
      new StatDefinition(FILEMGR_SEQUENTIAL_WRITES_NAME, FILEMGR_SEQUENTIAL_WRITES_DESC);

  public static final String FILEMGR_RANDOM_READ_BYTES_NAME = "nRandomReadBytes";
  ...
  public static final StatDefinition FILEMGR_RANDOM_READ_BYTES =
      new StatDefinition(FILEMGR_RANDOM_READ_BYTES_NAME, FILEMGR_RANDOM_READ_BYTES_DESC);

  public static final String FILEMGR_RANDOM_WRITE_BYTES_NAME = "nRandomWriteBytes";
  ...
  public static final StatDefinition FILEMGR_RANDOM_WRITE_BYTES =
      new StatDefinition(FILEMGR_RANDOM_WRITE_BYTES_NAME, FILEMGR_RANDOM_WRITE_BYTES_DESC);

  public static final String FILEMGR_SEQUENTIAL_READ_BYTES_NAME = "nSequentialReadBytes";
  ...
  public static final StatDefinition FILEMGR_SEQUENTIAL_READ_BYTES =
      new StatDefinition(FILEMGR_SEQUENTIAL_READ_BYTES_NAME, FILEMGR_SEQUENTIAL_READ_BYTES_DESC);

  public static final String FILEMGR_SEQUENTIAL_WRITE_BYTES_NAME = "nSequentialWriteBytes";
  ...
  public static final StatDefinition FILEMGR_SEQUENTIAL_WRITE_BYTES =
      new StatDefinition(FILEMGR_SEQUENTIAL_WRITE_BYTES_NAME, FILEMGR_SEQUENTIAL_WRITE_BYTES_DESC);

  public static final String FILEMGR_FILE_OPENS_NAME = "nFileOpens";
  ...
  public static final StatDefinition FILEMGR_FILE_OPENS =
      new StatDefinition(FILEMGR_FILE_OPENS_NAME, FILEMGR_FILE_OPENS_DESC);

  public static final String FILEMGR_OPEN_FILES_NAME = "nOpenFiles";
  ...
  public static final StatDefinition FILEMGR_OPEN_FILES =
      new StatDefinition(FILEMGR_OPEN_FILES_NAME, FILEMGR_OPEN_FILES_DESC, StatType.CUMULATIVE);

  public static final String FILEMGR_BYTES_READ_FROM_WRITEQUEUE_NAME = "nBytesReadFromWriteQueue";
  ...
  public static final StatDefinition FILEMGR_BYTES_READ_FROM_WRITEQUEUE =
      new StatDefinition(
          FILEMGR_BYTES_READ_FROM_WRITEQUEUE_NAME, FILEMGR_BYTES_READ_FROM_WRITEQUEUE_DESC);
  ...
  public static final StatDefinition FILEMGR_BYTES_WRITTEN_FROM_WRITEQUEUE =
      new StatDefinition(
          FILEMGR_BYTES_WRITTEN_FROM_WRITEQUEUE_NAME, FILEMGR_BYTES_WRITTEN_FROM_WRITEQUEUE_DESC);

  public static final String FILEMGR_READS_FROM_WRITEQUEUE_NAME = "nReadsFromWriteQueue";
  ...
  public static final StatDefinition FILEMGR_READS_FROM_WRITEQUEUE =
      new StatDefinition(FILEMGR_READS_FROM_WRITEQUEUE_NAME, FILEMGR_READS_FROM_WRITEQUEUE_DESC);

  public static final String FILEMGR_WRITES_FROM_WRITEQUEUE_NAME = "nWritesFromWriteQueue";
  ...
  public static final StatDefinition FILEMGR_WRITES_FROM_WRITEQUEUE =
      new StatDefinition(FILEMGR_WRITES_FROM_WRITEQUEUE_NAME, FILEMGR_WRITES_FROM_WRITEQUEUE_DESC);

  public static final String FILEMGR_WRITEQUEUE_OVERFLOW_NAME = "nWriteQueueOverflow";
  ...
  public static final StatDefinition FILEMGR_WRITEQUEUE_OVERFLOW =
      new StatDefinition(FILEMGR_WRITEQUEUE_OVERFLOW_NAME, FILEMGR_WRITEQUEUE_OVERFLOW_DESC);
  ...
  public static final StatDefinition FILEMGR_WRITEQUEUE_OVERFLOW_FAILURES =
      new StatDefinition(
          FILEMGR_WRITEQUEUE_OVERFLOW_FAILURES_NAME, FILEMGR_WRITEQUEUE_OVERFLOW_FAILURES_DESC);

  /* The following stat definitions are used in FSyncManager. */
  public static final String FSYNCMGR_FSYNCS_NAME = "nFSyncs";
  ...
  public static final StatDefinition FSYNCMGR_FSYNCS =
      new StatDefinition(FSYNCMGR_FSYNCS_NAME, FSYNCMGR_FSYNCS_DESC);

  public static final String FSYNCMGR_FSYNC_REQUESTS_NAME = "nFSyncRequests";
  ...
  public static final StatDefinition FSYNCMGR_FSYNC_REQUESTS =
      new StatDefinition(FSYNCMGR_FSYNC_REQUESTS_NAME, FSYNCMGR_FSYNC_REQUESTS_DESC);

  public static final String FSYNCMGR_TIMEOUTS_NAME = "nGrpCommitTimeouts";
  ...
  public static final String FILEMGR_LOG_FSYNCS_NAME = "nLogFSyncs";
  ...
  public static final StatDefinition FILEMGR_LOG_FSYNCS =
      new StatDefinition(FILEMGR_LOG_FSYNCS_NAME, FILEMGR_LOG_FSYNCS_DESC);

  /* The following stat definitions are used in GrpCommitManager. */
  public static final String GRPCMGR_FSYNC_TIME_NAME = "nFSyncTime";
  public static final String GRPCMGR_FSYNC_TIME_DESC = "Total fsync time in ms";
  public static final StatDefinition GRPCMGR_FSYNC_TIME =
      new StatDefinition(GRPCMGR_FSYNC_TIME_NAME, GRPCMGR_FSYNC_TIME_DESC);

  public static final String GRPCMGR_FSYNC_MAX_TIME_NAME = "nFSyncMaxTime";
  public static final String GRPCMGR_FSYNC_MAX_TIME_DESC = "Maximum fsync time in ms";
  public static final StatDefinition GRPCMGR_FSYNC_MAX_TIME =
      new StatDefinition(GRPCMGR_FSYNC_MAX_TIME_NAME, GRPCMGR_FSYNC_MAX_TIME_DESC);

  public static final String GRPCMGR_N_GROUP_COMMIT_REQUESTS_NAME = "nGroupCommitRequests";
  ...
  public static final StatDefinition GRPCMGR_N_GROUP_COMMIT_REQUESTS =
      new StatDefinition(
          GRPCMGR_N_GROUP_COMMIT_REQUESTS_NAME, GRPCMGR_N_GROUP_COMMIT_REQUESTS_DESC);

  public static final String GRPCMGR_N_GROUP_COMMIT_WAITS_NAME = "nGroupCommitWaits";
  ...
  public static final StatDefinition GRPCMGR_N_GROUP_COMMIT_WAITS =
      new StatDefinition(GRPCMGR_N_GROUP_COMMIT_WAITS_NAME, GRPCMGR_N_GROUP_COMMIT_WAITS_DESC);

  public static final String GRPCMGR_N_LOG_MAX_GROUP_COMMIT_NAME = "nLogMaxGroupCommitThreshold";
  ...
  public static final StatDefinition GRPCMGR_N_LOG_MAX_GROUP_COMMIT =
      new StatDefinition(GRPCMGR_N_LOG_MAX_GROUP_COMMIT_NAME, GRPCMGR_N_LOG_MAX_GROUP_COMMIT_DESC);

  public static final String GRPCMGR_N_LOG_INTERVAL_EXCEEDED_NAME = "nLogIntervalExceeded";
  ...
  public static final StatDefinition GRPCMGR_N_LOG_INTERVAL_EXCEEDED =
      new StatDefinition(
          GRPCMGR_N_LOG_INTERVAL_EXCEEDED_NAME, GRPCMGR_N_LOG_INTERVAL_EXCEEDED_DESC);

  /* The following stat definitions are used in LogManager. */
  public static final String LOGMGR_REPEAT_FAULT_READS_NAME = "nRepeatFaultReads";
  ...
  public static final StatDefinition LOGMGR_REPEAT_FAULT_READS =
      new StatDefinition(LOGMGR_REPEAT_FAULT_READS_NAME, LOGMGR_REPEAT_FAULT_READS_DESC);

  public static final String LOGMGR_TEMP_BUFFER_WRITES_NAME = "nTempBufferWrites";
  ...
  public static final StatDefinition LOGMGR_TEMP_BUFFER_WRITES =
      new StatDefinition(LOGMGR_TEMP_BUFFER_WRITES_NAME, LOGMGR_TEMP_BUFFER_WRITES_DESC);

  public static final String LOGMGR_END_OF_LOG_NAME = "endOfLog";
  ...
  public static final StatDefinition LOGMGR_END_OF_LOG =
      new StatDefinition(LOGMGR_END_OF_LOG_NAME, LOGMGR_END_OF_LOG_DESC, StatType.CUMULATIVE);

  public static final String LBFP_NO_FREE_BUFFER_NAME = "nNoFreeBuffer";
  ...
  public static final StatDefinition LBFP_NO_FREE_BUFFER =
      new StatDefinition(LBFP_NO_FREE_BUFFER_NAME, LBFP_NO_FREE_BUFFER_DESC);

  /* The following stat definitions are used in LogBufferPool. */
  public static final String LBFP_NOT_RESIDENT_NAME = "nNotResident";
  ...
  public static final StatDefinition LBFP_NOT_RESIDENT =
      new StatDefinition(LBFP_NOT_RESIDENT_NAME, LBFP_NOT_RESIDENT_DESC);

  public static final String LBFP_MISS_NAME = "nCacheMiss";
  public static final String LBFP_MISS_DESC =
      "Total number of requests for database objects which were not in " + "memory.";
  public static final StatDefinition LBFP_MISS = new StatDefinition(LBFP_MISS_NAME, LBFP_MISS_DESC);

  public static final String LBFP_LOG_BUFFERS_NAME = "nLogBuffers";
  ...
  public static final StatDefinition LBFP_LOG_BUFFERS =
      new StatDefinition(LBFP_LOG_BUFFERS_NAME, LBFP_LOG_BUFFERS_DESC, StatType.CUMULATIVE);

  public static final String LBFP_BUFFER_BYTES_NAME = "bufferBytes";
  ...
  public static final StatDefinition LBFP_BUFFER_BYTES =
      new StatDefinition(LBFP_BUFFER_BYTES_NAME, LBFP_BUFFER_BYTES_DESC, StatType.CUMULATIVE);
}

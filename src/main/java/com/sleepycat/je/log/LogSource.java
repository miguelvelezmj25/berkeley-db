...
public interface LogSource {
  ...
  /**
   * Fill the destination byte array with bytes. The offset indicates the absolute log file
   * position.
   */
  ByteBuffer getBytes(long fileOffset) throws DatabaseException;

  /**
   * Fill the destination byte array with the requested number of bytes. The offset indicates the
   * absolute position in the log file.
   */

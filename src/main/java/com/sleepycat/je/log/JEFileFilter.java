...
class JEFileFilter implements FilenameFilter {
  ...
  /** @param maxFileNumber this filter will only return files that are numbers <= maxFileNumber. */
  ...
  /**
   * @param minFileNumber this filter will only return files that are >= minFileNumber.
   * @param maxFileNumber this filter will only return files that are numbers <= maxFileNumber.
   */

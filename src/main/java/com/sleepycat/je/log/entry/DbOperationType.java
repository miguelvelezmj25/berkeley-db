...
/**
 * DbOperationType is a persistent enum used in NameLNLogEntries. It supports replication of
 * database operations by documenting the type of api operation which instigated the logging of a
 * NameLN.
 */
public enum DbOperationType implements VersionedWriteLoggable {
  ...
  DbOperationType(byte value) {
    this.value = value;
  }

  public static DbOperationType readTypeFromLog(
      final ByteBuffer entryBuffer, @SuppressWarnings("unused") int entryVersion) {
  ...
  public boolean logicalEquals(Loggable other) {
    if (!(other instanceof DbOperationType)) return false;

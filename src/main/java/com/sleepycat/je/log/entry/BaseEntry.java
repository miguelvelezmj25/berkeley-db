 ...
 *
 * <p>The log entry on disk consists of a. a log header defined by LogManager b. a VLSN, if this
 * entry type requires it, and replication is on. c. the specific contents of the log entry.
 *
 * <p>This class encompasses (b and c).
 *
...
abstract class BaseEntry<T extends Loggable> implements LogEntry {
  ...
  /**
   * Returns the class of the contained loggable item or items, or null if the instance was created
   * to write an entry.
   *
  ...
  /**
   * By default, this log entry is complete and does not require fetching additional entries. This
   * method is overridden by BINDeltaLogEntry.
   */
  @Override
  ...
  public void postLogWork(
      @SuppressWarnings("unused") LogEntryHeader header,

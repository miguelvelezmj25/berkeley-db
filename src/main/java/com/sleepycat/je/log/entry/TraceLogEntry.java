...
public class TraceLogEntry extends SingleItemReplicableEntry<Trace> {
  ...
  /**
   * The log version number of the most recent change for this log entry, including any changes to
   * the format of the underlying {@link Trace} object.
   *
  ...
  /**
   * If non-null, write this object when asked to write in the log format prior to the last changed
   * version, for testing.
   */
  ...
  /**
   * Specify an object to write instead of the enclosed item when asked to write this entry in the
   * log format prior to the last changed version, for testing.
   */

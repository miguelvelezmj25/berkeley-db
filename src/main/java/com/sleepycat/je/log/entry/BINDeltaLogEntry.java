 ...
 *
 * <p>A live delta (unlike a the obsolete OldBINDelta, which is contained in an OldBINDeltaLogEntry)
 * may appear in the Btree to serve as an incomplete BIN.
 */

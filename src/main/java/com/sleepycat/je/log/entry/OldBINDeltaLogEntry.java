...
/**
 * Before log version 9, this was used to hold a OldBINDelta that can be combined with a BIN when
 * fetched from the log; see getResolvedItem. This class was replaced by BINDeltaLogEntry in log
 * version 9, which can be used to create a live (but incomplete) BIN in the Btree.
 */

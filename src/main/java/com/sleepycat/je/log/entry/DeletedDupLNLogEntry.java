...
/**
 * DupDeletedLNEntry encapsulates a deleted dupe LN entry. This contains all the regular
 * transactional LN log entry fields and an extra key, which is the nulled out data field of the LN
 * (which becomes the key in the duplicate tree.
 *
 * <p>WARNING: Obsolete in version 8, only used by some log readers.
 *
 * <p>TODO Move to dupConvert package, after testing is complete.
 */

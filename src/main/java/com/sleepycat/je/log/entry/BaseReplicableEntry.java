...
/**
 * A basic implementation of a replicable log entry that provides for writing in a single format by
 * default. Starting with log version 9, as specified by {@link
 * LogEntryType#LOG_VERSION_REPLICATE_OLDER}, entry classes whose log format has changed since the
 * previous log version will need to override the {@link ReplicableLogEntry#getLastFormatChange},
 * {@link #getSize(int, boolean)} and {@link #writeEntry(ByteBuffer, int, boolean)} methods to

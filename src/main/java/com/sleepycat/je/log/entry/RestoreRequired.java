...
/**
 * This log entry is used to indicate that the environment's log files are not recoverable and that
 * some sort of curative action should happen first. It's a general purpose mechanism that can be
 * used for many types of errors.
 */
public class RestoreRequired implements Loggable {
  ...
  public boolean logicalEquals(Loggable other) {
    ...
    if (!time.equals(otherEntry.time)) {
      ...
      return propVals.equals(otherEntry.propVals);
  }

 ...
 *
 * <p>This class is used as a simple struct for returning multiple values, and does not need getters
 * and setters.
 */
public class LogItem {

  /**
   * LSN of the new log entry. Is NULL_LSN if a BIN-delta is logged. If not NULL_LSN for a tree
   * node, is typically used to update the slot in the parent IN.
   */
  ...
  /** The header of the new log entry. Used by HA to do VLSN tracking and implement a tip cache. */

...
public class INCompStatDefinition {
  ...
  public static final String INCOMP_SPLIT_BINS_NAME = "splitBins";
  ...
  public static final StatDefinition INCOMP_SPLIT_BINS =
      new StatDefinition(INCOMP_SPLIT_BINS_NAME, INCOMP_SPLIT_BINS_DESC);

  public static final String INCOMP_DBCLOSED_BINS_NAME = "dbClosedBins";
  ...
  public static final StatDefinition INCOMP_DBCLOSED_BINS =
      new StatDefinition(INCOMP_DBCLOSED_BINS_NAME, INCOMP_DBCLOSED_BINS_DESC);

  public static final String INCOMP_CURSORS_BINS_NAME = "cursorsBins";
  ...
  public static final StatDefinition INCOMP_CURSORS_BINS =
      new StatDefinition(INCOMP_CURSORS_BINS_NAME, INCOMP_CURSORS_BINS_DESC);

  public static final String INCOMP_NON_EMPTY_BINS_NAME = "nonEmptyBins";
  ...
  public static final StatDefinition INCOMP_NON_EMPTY_BINS =
      new StatDefinition(INCOMP_NON_EMPTY_BINS_NAME, INCOMP_NON_EMPTY_BINS_DESC);

  public static final String INCOMP_PROCESSED_BINS_NAME = "processedBins";
  ...
  public static final StatDefinition INCOMP_PROCESSED_BINS =
      new StatDefinition(INCOMP_PROCESSED_BINS_NAME, INCOMP_PROCESSED_BINS_DESC);

  public static final String INCOMP_QUEUE_SIZE_NAME = "inCompQueueSize";
  ...
  public static final StatDefinition INCOMP_QUEUE_SIZE =
      new StatDefinition(INCOMP_QUEUE_SIZE_NAME, INCOMP_QUEUE_SIZE_DESC);
}

...
/**
 * Specifies the attributes of a checkpoint operation invoked from {@link Environment#checkpoint
 * Environment.checkpoint}.
 */
public class CheckpointConfig implements Cloneable {

  /**
   * Default configuration used if null is passed to {@link Environment#checkpoint
   * Environment.checkpoint}.
   */
   ...
   *
   * <p>The default is 0 for this class and the database environment.
   *
   * @param kBytes If the kBytes parameter is non-zero, a checkpoint will be performed if more than
   ...
   * <p>The default is 0 for this class and the database environment.
   *
   * @param minutes If the minutes parameter is non-zero, a checkpoint is performed if more than min
   ...
   *
   * <p>The default is false for this class and the BDB JE environment.
   *
   * @param force If set to true, force a checkpoint, even if there has been no activity since the
   *     last checkpoint.
   * @return this
   */
   ...
   * <p>The default is false for this class and the BDB JE environment.
   *
   * @param minimizeRecoveryTime If set to true, the checkpoint will itself take longer but will
   *     cause a subsequent recovery (Environment.open) to finish more quickly.
   * @return this
   */

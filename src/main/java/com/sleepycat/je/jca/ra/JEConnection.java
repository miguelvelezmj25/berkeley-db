...
/**
 * A JEConnection provides access to JE services. See &lt;JEHOME&gt;/examples/jca/HOWTO-**.txt and
 * &lt;JEHOME&gt;/examples/jca/simple/SimpleBean.java for more information on how to build the
 * resource adaptor and use a JEConnection.
 */
public class JEConnection implements Closeable {
  ...
  public SecondaryDatabase openSecondaryDatabase(
      String name, Database primaryDatabase, SecondaryConfig config) throws DatabaseException {

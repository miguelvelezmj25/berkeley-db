 ...
 * @hidden
 *     <!-- end JE only -->
 *     An <code>EntryBinding</code> that treats a record number key entry as a <code>Long</code> key
 *     object.
 *     <p>Record numbers are returned as <code>Long</code> objects, although on input any <code>
 *     Number</code> object may be used.
 * @author Mark Hayes
 */

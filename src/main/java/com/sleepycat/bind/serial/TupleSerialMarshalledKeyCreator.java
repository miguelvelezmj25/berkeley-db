...
/**
 * A concrete key creator that works in conjunction with a {@link TupleSerialMarshalledBinding}.
 * This key creator works by calling the methods of the {@link MarshalledTupleKeyEntity} interface
 * to create and clear the index key fields.
 *
...
public class TupleSerialMarshalledKeyCreator<D extends MarshalledTupleKeyEntity>
  ...
  private final TupleSerialMarshalledBinding<D> binding;
   ...
   */
  public TupleSerialMarshalledKeyCreator(TupleSerialMarshalledBinding<D> binding, String keyName) {
  ...
  public boolean createSecondaryKey(
     ...
     * primary key.
     */
    MarshalledTupleKeyEntity entity = binding.entryToObject(primaryKeyInput, dataInput);
  ...
  public D nullifyForeignKey(D dataInput) {
    ...
    MarshalledTupleKeyEntity entity = binding.entryToObject(null, dataInput);

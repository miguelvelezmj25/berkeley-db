...
/**
 * An abstract <code>EntityBinding</code> that treats an entity's key entry and data entry as
 * serialized objects.
 *
 * <p>This class takes care of serializing and deserializing the key and data entry automatically.
 * Its three abstract methods must be implemented by a concrete subclass to convert the deserialized
 * objects to/from an entity object.
 *
 * <ul>
 *   <li>{@link #entryToObject(Object,Object)}
 *   <li>{@link #objectToKey(Object)}
 *   <li>{@link #objectToData(Object)}
 * </ul>
 *
...
public abstract class SerialSerialBinding<K, D, E> implements EntityBinding<E> {
  ...
  private final SerialBinding<K> keyBinding;
  private final SerialBinding<D> dataBinding;
   ...
   */
  public SerialSerialBinding(ClassCatalog classCatalog, Class<K> keyClass, Class<D> dataClass) {

    this(
        new SerialBinding<K>(classCatalog, keyClass),
   ...
   */
  public SerialSerialBinding(SerialBinding<K> keyBinding, SerialBinding<D> dataBinding) {

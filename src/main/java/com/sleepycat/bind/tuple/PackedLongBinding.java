...
/**
 * A concrete <code>TupleBinding</code> for an unsorted <code>Long</code> primitive wrapper or an
 * unsorted <code>long</code> primitive, that stores the value in the smallest number of bytes
 * possible.
 *
...
public class PackedLongBinding extends TupleBinding<Long> {
  ...
  /**
   * Converts a simple <code>Long</code> value into an entry buffer, using PackedLong format.
   *

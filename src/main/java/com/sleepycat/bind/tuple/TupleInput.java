...
/**
 * An <code>InputStream</code> with <code>DataInput</code>-like methods for reading tuple fields. It
 * is used by <code>TupleBinding</code>.
 *
 * <p>This class has many methods that have the same signatures as methods in the {@link
 * java.io.DataInput} interface. The reason this class does not implement {@link java.io.DataInput}
 * is because it would break the interface contract for those methods because of data format
 * differences.
 *
...
public class TupleInput extends FastInputStream {
  ...
  /**
   * Creates a tuple input object for reading a byte array of tuple data. A reference to the byte
   * array will be kept by this object (it will not be copied) and therefore the byte array should
   * not be modified while this object is in use.
   *
   * @param buffer is the byte array to be read and should contain data in tuple format.
   */
  ...
  /**
   * Creates a tuple input object for reading a byte array of tuple data at a given offset for a
   * given length. A reference to the byte array will be kept by this object (it will not be copied)
   * and therefore the byte array should not be modified while this object is in use.
   *
   * @param buffer is the byte array to be read and should contain data in tuple format.
  ...
  /**
   * Creates a tuple input object from the data contained in a tuple output object. A reference to
   * the tuple output's byte array will be kept by this object (it will not be copied) and therefore
   * the tuple output object should not be modified while this object is in use.
   *
  ...
  /**
   * Reads a null-terminated UTF string from the data buffer and converts the data from UTF to
   * Unicode. Reads values that were written using {@link TupleOutput#writeString(String)}.
   *
   * @return the converted string.
   * @throws IndexOutOfBoundsException if no null terminating byte is found in the buffer.
  ...
  /**
   * Reads a boolean (one byte) unsigned value from the buffer and returns true if it is non-zero
   * and false if it is zero. Reads values that were written using {@link TupleOutput#writeBoolean}.
   *
   * @return the value read from the buffer.
   * @throws IndexOutOfBoundsException if not enough bytes are available in the buffer.
   * @see <a href="package-summary.html#integerFormats">Integer Formats</a>
  ...
  /**
   * Reads an unsorted double (eight byte) value from the buffer. Reads values that were written
   * using {@link TupleOutput#writeDouble}.
   *
   * @return the value read from the buffer.
   * @throws IndexOutOfBoundsException if not enough bytes are available in the buffer.
   * @see <a href="package-summary.html#floatFormats">Floating Point Formats</a>
  ...
  /**
   * This method is private since an unsigned long cannot be treated as such in Java, nor converted
   * to a BigInteger of the same value.
   */
  ...
  /**
   * Reads the specified number of bytes from the buffer, converting each unsigned byte value to a
   * character of the resulting string. Reads values that were written using {@link
  ...
  /**
   * Reads the specified number of characters from the buffer, converting each two byte unsigned
   * value to a character of the resulting string. Reads values that were written using {@link
  ...
  /**
   * Reads the specified number of bytes from the buffer, converting each unsigned byte value to a
   * character of the resulting array. Reads values that were written using {@link
   * TupleOutput#writeBytes}.
   *
   * @param chars is the array to receive the data and whose length is used to determine the number
   *     of bytes to be read.
   * @throws IndexOutOfBoundsException if not enough bytes are available in the buffer.
   * @see <a href="package-summary.html#integerFormats">Integer Formats</a>
   */
  ...
  /**
   * Reads the specified number of characters from the buffer, converting each two byte unsigned
   * value to a character of the resulting array. Reads values that were written using {@link
   * TupleOutput#writeChars}.
   *
   * @param chars is the array to receive the data and whose length is used to determine the number
  ...
  /**
   * Reads the specified number of UTF characters string from the data buffer and converts the data
   * from UTF to Unicode. Reads values that were written using {@link
  ...
  /**
   * Returns the byte length of a null-terminated UTF string in the data buffer, including the
   * terminator. Used with string values that were written using {@link
  ...
  /**
   * Reads a sorted {@code BigDecimal} in normalized format with a single digit to the left of the
   * decimal point.
   */

 ...
 * TupleOutput} objects. Its three abstract methods must be implemented by a concrete subclass to
 * convert between tuples and entity objects.
 *
 * <ul>
 *   <li>{@link #entryToObject(TupleInput,TupleInput)}
 *   <li>{@link #objectToKey(Object,TupleOutput)}
 *   <li>{@link #objectToData(Object,TupleOutput)}
 * </ul>
 *
 * @author Mark Hayes
 */
public abstract class TupleTupleBinding<E> extends TupleBase<E> implements EntityBinding<E> {
   ...
   * @param output is the {@link TupleOutput} to which the key should be written.
   */
   ...
   *
   * @param object is the entity object.
   * @param output is the {@link TupleOutput} to which the data should be written.
   */

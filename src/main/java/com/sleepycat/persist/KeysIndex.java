...
/**
 * The EntityIndex returned by SecondaryIndex.keysIndex(). This index maps secondary key to primary
 * key. In Berkeley DB internal terms, this is a secondary database that is opened without
 * associating it with a primary.
 *
 * @author Mark Hayes
 */
class KeysIndex<SK, PK> extends BasicIndex<SK, PK> {
  ...
  /* <!-- begin JE only --> */
  public EntityResult<PK> get(Transaction txn, SK key, Get getType, ReadOptions options)
      throws DatabaseException {

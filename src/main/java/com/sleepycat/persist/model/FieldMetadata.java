...
/**
 * The metadata for a key field. This class defines common properties for singular and composite key
 * fields.
 *
 * <p>{@code FieldMetadata} objects are thread-safe. Multiple threads may safely call the methods of
 * a shared {@code FieldMetadata} object.
 *
 * @author Mark Hayes
 */

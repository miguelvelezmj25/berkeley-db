...
/**
 * The metadata for a persistent entity class. An entity class may be specified with the {@link
 * Entity} annotation.
 *
 * <p>{@code EntityMetadata} objects are thread-safe. Multiple threads may safely call the methods
 * of a shared {@code EntityMetadata} object.
 *
 * @author Mark Hayes
 */
public class EntityMetadata implements Serializable {
  ...
  /**
   * Returns the primary key metadata for this entity. Note that the primary key field may be
   * declared in this class or in a subclass. This metadata may be specified using the {@link
  ...
  /**
   * Returns an unmodifiable map of key name to secondary key metadata, or an empty map if no
   * secondary keys are defined for this entity. The returned map contains a mapping for each
   * secondary key of this entity, including secondary keys declared in subclasses and superclasses.

...
/**
 * The metadata for a secondary key field. A secondary key may be specified with the {@link
 * SecondaryKey} annotation.
 *
 * <p>{@code SecondaryKeyMetadata} objects are thread-safe. Multiple threads may safely call the
 * methods of a shared {@code SecondaryKeyMetadata} object.
 *
 * @author Mark Hayes
 */
public class SecondaryKeyMetadata extends FieldMetadata {
   ...
   * @param declaringClassName the name of the class where the field is declared.
  ...
  /**
   * Returns the class name of the array or collection element for a {@link Relationship#ONE_TO_MANY
   * ONE_TO_MANY} or {@link Relationship#MANY_TO_MANY MANY_TO_MANY} relationship, or null for a
   * Relationship#ONE_TO_ONE ONE_TO_ONE} or {@link Relationship#MANY_TO_ONE MANY_TO_ONE}
   * relationship.
   *
  ...
  /**
   * Returns the relationship between instances of the entity class and the secondary keys. This may
   * be specified using the {@link SecondaryKey#relate} annotation.
   *
  ...
  /**
   * Returns the class name of the related (foreign) entity, for which foreign key constraints are
   * specified using the {@link SecondaryKey#relatedEntity} annotation.
   *
  ...
  /**
   * Returns the action to take when a related entity is deleted having a primary key value that
   * exists as a secondary key value for this entity. This may be specified using the {@link

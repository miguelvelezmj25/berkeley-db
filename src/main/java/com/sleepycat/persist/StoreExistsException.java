...
/**
 * Thrown by the {@link EntityStore} constructor when the {@link StoreConfig#setExclusiveCreate
 * ExclusiveCreate} configuration parameter is true and the store's internal catalog database
 * already exists.
 *
 * @author Mark Hayes
 */

...
/**
 * A raw instance that can be used with a {@link RawStore} or {@link Conversion}. A <code>RawObject
 * </code> is used to represent instances of complex types (persistent classes with fields), arrays,
 * and enum values. It is not used to represent non-enum simple types, which are represented as
 * simple objects. This includes primitives, which are represented as instances of their wrapper
 * class.
 *
 * <p>{@code RawObject} objects are thread-safe. Multiple threads may safely call the methods of a
 * shared {@code RawObject} object.
 *
 * @author Mark Hayes
 */
public class RawObject {
   ...
   * @param values a map of field name to value for each declared field in the class, or null to
   *     create an empty map. Each value in the map is a {@link RawObject}, a <a
   *     href="../model/Entity.html#simpleTypes">simple type</a> instance, or null.
   * @param superObject the instance of the superclass, or null if the superclass is {@code Object}.
   ...
   *
   * @param type the type of this raw object.
   * @param elements an array of elements. Each element in the array is a {@link RawObject}, a <a
   *     href="../model/Entity.html#simpleTypes">simple type</a> instance, or null.
   * @throws IllegalArgumentException if the type argument is not an array type.
   */
   ...
   *
   * @param type the type of this raw object.
   * @param enumConstant the String value of this enum constant; must be one of the Strings returned
   *     by {@link RawType#getEnumConstants}.
   * @throws IllegalArgumentException if the type argument is not an array type.
   */
   ...
   *
   * <p>Note that if this object is unevolved, the returned type may be different from the current
   * type returned by {@link EntityModel#getRawType EntityModel.getRawType} for the same class name.
   * This can only occur in a {@link Conversion#convert Conversion.convert}.
   *
   * @return the RawType.
   */
  ...
  /**
   * Returns a map of field name to value for a complex type, or null for an array type or an enum
   * type. The map contains a String key for each declared field in the class. Each value in the map
   * is a {@link RawObject}, a <a href="../model/Entity.html#simpleTypes">simple type</a> instance,
   * or null.
   *
   * <p>There will be an entry in the map for every field declared in this type, as determined by
   * {@link RawType#getFields} for the type returned by {@link #getType}. Values in the map may be
   * null for fields with non-primitive types.
   *
   ...
   * Each element in the array is a {@link RawObject}, a <a
   * href="../model/Entity.html#simpleTypes">simple type</a> instance, or null.
   *
   ...
   * The String returned will be one of the Strings returned by {@link RawType#getEnumConstants}.
   *
  ...
  /**
   * Returns the instance of the superclass, or null if the superclass is {@code Object} or {@code
   * Enum}.
   *
  ...
  public boolean equals(Object other) {
    ...
    if (superObject != null) {
        return superObject.equals(o.superObject);
    } else {
        return o.superObject == null;
    }
  }

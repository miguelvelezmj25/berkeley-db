...
/**
 * A mutation for renaming a class or field without changing the instance or field value. For
 * example:
 *
 * <pre class="code">
 *  package my.package;
 ...
 * <!-- begin JE only -->
 *
 * <p>In a replicated environment, renaming an entity class or secondary key field may require
 * handling the {@link com.sleepycat.je.rep.DatabasePreemptedException} during the upgrade process.
 * See <a href="package-summary.html#repUpgrade">Upgrading a Replication Group</a> for more
 * information.
 * <!-- end JE only -->
 *
...
public class Renamer extends Mutation {
   ...
   * @param declaringClassVersion the class version to which this mutation applies.
   * @param fromField field name in the given class version.
   * @param toField the new field name.
   */
  public Renamer(
      String declaringClass, int declaringClassVersion, String fromField, String toField) {
  ...
  /**
   * Returns true if the new class name is equal in this object and given object, and if the {@link

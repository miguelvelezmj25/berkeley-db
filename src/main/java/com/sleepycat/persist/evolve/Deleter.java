 ...
 *
 * <p><strong>WARNING:</strong> The data for the deleted class or field will be destroyed and will
 * be recoverable only by restoring from backup. If you wish to convert the instance data to a
 * different type or format, use a {@link Conversion} mutation instead.
 *
 * <p>For example, to delete a field:
 *
 * <pre class="code">
 *  package my.package;
 *

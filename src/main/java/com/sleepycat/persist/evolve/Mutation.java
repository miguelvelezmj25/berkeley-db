...
public abstract class Mutation implements Serializable {
  ...
  /**
   * Returns the field name to which this mutation applies, or null if this mutation applies to the
   * class itself.
   *
  ...
  /**
   * Returns true if the class name, class version and field name are equal in this object and given
   * object.
   */
  @Override

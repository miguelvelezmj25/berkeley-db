...
/**
 * A mutation for converting an old version of an object value to conform to the current class or
 ...
 *
 * <p>See {@link Conversion} for more information.
 *
...
public class Converter extends Mutation {
  ...
  /**
   * Creates a mutation for converting all instances of the given class version to the current
  ...
  public String toString() {
    return "[Converter " + super.toString() + " Conversion: " + conversion + ']';
  }
}

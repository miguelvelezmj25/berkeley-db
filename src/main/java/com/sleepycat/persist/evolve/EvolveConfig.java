...
/**
 * Configuration properties for eager conversion of unevolved objects. This configuration is used
 * with {@link EntityStore#evolve EntityStore.evolve}.
 *
...
public class EvolveConfig implements Cloneable {
  ...
  private final Set<String> classesToEvolve;
  ...
  /**
   * Adds an entity class for a primary index to be converted. If no classes are added, all indexes
   * that require evolution will be converted.
   *

...
public class EnhancedAccessor implements Accessor {
  ...
  private final Enhanced prototype;
  private Format priKeyFormat;
  private Format[] compositeKeyFormats;
  private final Class type;

  /**
   * Registers a prototype instance, and should be called during initialization of the prototype
   * class. The prototype may be null for an abstract class.
   */

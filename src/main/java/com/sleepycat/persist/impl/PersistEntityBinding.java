...
public class PersistEntityBinding implements EntityBinding {
  ...
  /**
   * This method is always called after reading an entity. If a refresh is needed, we detect that in
   * PersistCatalog.getFormat(int).
   */
  private Object entryToObjectInternal(
      final DatabaseEntry key, final Object priKey, final DatabaseEntry data)
  ...
  static Object readEntity(
    ...
    if (priKey == null) {
       ...
       * field. [#19248]
       */
      Accessor accessor = reader.getAccessor(entity instanceof RawObject || rawAccess);
      if (accessor == null) {
        accessor =
            format
                .getLatestVersion()
                .getReader()
                .getAccessor(entity instanceof RawObject || rawAccess);
      }

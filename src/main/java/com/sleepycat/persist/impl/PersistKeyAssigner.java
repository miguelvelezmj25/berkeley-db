 ...
 *
 * <p>This class is used directly by PrimaryIndex, not via an interface. To avoid making a public
 * interface, the PersistEntityBinding contains a reference to a PersistKeyAssigner, and the
 * PrimaryIndex gets the key assigner from the binding. See the PrimaryIndex constructor for more
 * information.
 *
 * @author Mark Hayes
 */
public class PersistKeyAssigner {
  ...
  PersistKeyAssigner(
      PersistKeyBinding keyBinding, PersistEntityBinding entityBinding, Sequence sequence) {

...
/**
 * Read-only catalog operations used when initializing new formats. This catalog is used temprarily
 * when the main catalog has not been updated yet, but the new formats need to do catalog lookups.
 *

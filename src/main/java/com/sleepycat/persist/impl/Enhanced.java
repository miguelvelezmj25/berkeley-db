 ...
 *
 * <p>See {@link Accessor} for method documentation. {@link EnhancedAccessor} implements Accessor
 * and forwards all calls to methods in the Enhanced class.
 *
 * <p>Each class that implements this interface (including its subclasses and superclasses except
 * for Object) must also implement a static block that registers a prototype instance by calling
 * EnhancedAccessor.registerPrototype. Other instances are created from the protype instance using
 * {@link #bdbNewInstance}.
 *
 * <pre>static { EnhancedAccessor.registerPrototype(new Xxx()); }</pre>
 *
 * <p>An example of the generated code for reading and writing fields is shown below.
 *
 * <pre>
 *  private int f1;
 *  private String f2;

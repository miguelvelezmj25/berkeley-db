...
/**
 * The EntityModel used when a RawStore is opened. The metadata and raw type information comes from
 * the catalog directly, without using the current class definitions.
 *
 * @author Mark Hayes
 */
class StoredModel extends EntityModel {
  ...
  /**
   * This method is used to initialize the model when catalog creation is complete, and reinitialize
   * it when a Replica refresh occurs.
   */
  @Override

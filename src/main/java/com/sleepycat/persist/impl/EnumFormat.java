 ...
 *
 * <p>In this class we resort to using reflection to allocate arrays of enums. If there is a need
 * for it, reflection could be avoided in the future by generating code as new array formats are
 * encountered.
 *
 * @author Mark Hayes
 */
